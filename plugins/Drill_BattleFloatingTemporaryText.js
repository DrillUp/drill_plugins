...
// * 标记容器 - 初始化
//==============================
var _drill_BFTT_sTank_initialize = Game_Temp.prototype.initialize;
Game_Temp.prototype.initialize = function() {
	_drill_BFTT_sTank_initialize.call(this);
	
	this._drill_BFTT_EnemiesSpriteTank = [];		//敌人贴图
	this._drill_BFTT_ActorSpriteTank = [];			//角色贴图
};
//==============================
// * 标记容器 - 获取敌方索引
//==============================
Game_Temp.prototype.drill_BFTT_getEnemySpriteByIndex = function( index ) {
	for(var i=0; i < this._drill_BFTT_EnemiesSpriteTank.length; i++){
		var enemy_sprite = this._drill_BFTT_EnemiesSpriteTank[i];
...
Game_Temp.prototype.drill_BFTT_getActorSpriteByIndex = function( index ) {
	for(var i=0; i < this._drill_BFTT_ActorSpriteTank.length; i++){
		var actor_sprite = this._drill_BFTT_ActorSpriteTank[i];
...
// * 捕获 - 战斗敌人贴图创建
//==============================
var _drill_BFTT_sTank_createEnemies = Spriteset_Battle.prototype.createEnemies;
Spriteset_Battle.prototype.createEnemies = function() {
	_drill_BFTT_sTank_createEnemies.call(this);
	$gameTemp._drill_BFTT_EnemiesSpriteTank = this._enemySprites;
};
//==============================
// * 捕获 - 战斗角色贴图创建
//==============================
var _drill_BFTT_sTank_createActors = Spriteset_Battle.prototype.createActors;
Spriteset_Battle.prototype.createActors = function() {
	_drill_BFTT_sTank_createActors.call(this);
	$gameTemp._drill_BFTT_ActorSpriteTank = this._enemySprites;
};
//==============================
// * 标记容器 - 清空
//==============================
var _drill_BFTT_sTank_terminate = Scene_Battle.prototype.terminate;
Scene_Battle.prototype.terminate = function() {
	_drill_BFTT_sTank_terminate.call(this);
	$gameTemp._drill_BFTT_EnemiesSpriteTank = [];		//敌人贴图
	$gameTemp._drill_BFTT_ActorSpriteTank = [];			//角色贴图
};
...
Spriteset_Battle.prototype.createPictures = function() {
	_drill_BFTT_layer_createPictures.call(this);		//rmmv图片 < 图片层 < rmmv对话框
...
Scene_Battle.prototype.createAllWindows = function() {
	_drill_BFTT_layer_createAllWindows.call(this);	//rmmv对话框 < 最顶层
...
Scene_Battle.prototype.update = function() {	
	...
	if( this.isActive() ){
		this.drill_BFTT_updateWindowAddChild();			//插件指令建立贴图
		this.drill_BFTT_updateWindowDelete();			//贴图删除
	}
};
//==============================
// * 帧刷新 - 插件指令设置贴图
...
// * 帧刷新 - 位置
//==============================
Drill_BFTT_Window.prototype.drill_updatePosition = function() {
	var s_data = this._drill_style_data;
	var b_data = this._drill_ballistics_data;
	...
	if( Imported.Drill_BattleCamera ){
		...
		// > UI基准偏移（相对于战斗场景）
		if( s_data['window_benchmark'] == "相对于战斗场景" ){
			if( s_data['window_battle_layer'] == '下层' ||		//（由于 上层和下层 位于_battleField中，所以计算方式与其他不一样）
				s_data['window_battle_layer'] == '上层' ){
...
//=============================================================================
		...
		alert(
			"【Drill_BattleFloatingTemporaryText.js 战斗UI - 漂浮参数数字】\n缺少基础插件，去看看下列插件是不是 未添加 / 被关闭 / 顺序不对："+
