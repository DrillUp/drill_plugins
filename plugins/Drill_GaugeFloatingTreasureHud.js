 ...
 * @desc 漂浮文字的内容配置信息。
 * @default {"标签":"==默认皮肤_蓝==","---常规---":"","总持续时长":"480","移动时间":"20","移动方式":"匀速移动","偏移-物品框起点 X":"120","偏移-物品框起点 Y":"0","物品框间距":"2","推进方向":"向上","最大推进数量":"8","---物品框---":"","获得时数字的颜色":"24","失去时数字的颜色":"18","获得物品时是否显示":"true","失去物品时是否显示":"true","物品表示方式":"图标+文本","获得武器时是否显示":"true","失去武器时是否显示":"true","武器表示方式":"图标+文本","获得护甲时是否显示":"true","失去护甲时是否显示":"true","护甲表示方式":"图标+文本","获得金钱时是否显示":"true","失去金钱时是否显示":"true","金钱表示方式":"图标+文本","---层级---":"","UI基准":"相对于镜头","地图层级":"图片层","地图图片层级":"80","---窗口皮肤---":"","布局模式":"默认窗口皮肤","布局透明度":"255","资源-自定义窗口皮肤":"Window","资源-自定义背景图片":"(需配置)临时漂浮文字-自定义背景图片","平移-自定义背景图片 X":"0","平移-自定义背景图片 Y":"0","是否锁定窗口色调":"false","窗口色调-红":"0","窗口色调-绿":"0","窗口色调-蓝":"0","---窗口属性---":"","窗口中心锚点":"右下角","窗口内边距":"10","窗口字体大小":"20","窗口附加宽度":"0","窗口附加高度":"0"}
 * 
 * @param 物品框样式-2
 * @parent ---样式组 1至20---
 * @type struct<DrillGFTHStyle>
 * @desc 漂浮文字的内容配置信息。
 * @default {"标签":"==默认皮肤_蓝+向左推进==","---常规---":"","总持续时长":"480","移动时间":"20","移动方式":"匀速移动","偏移-物品框起点 X":"120","偏移-物品框起点 Y":"0","物品框间距":"2","推进方向":"向左","最大推进数量":"5","---物品框---":"","获得时数字的颜色":"24","失去时数字的颜色":"18","获得物品时是否显示":"true","失去物品时是否显示":"true","物品表示方式":"图标+文本","获得武器时是否显示":"true","失去武器时是否显示":"true","武器表示方式":"图标+文本","获得护甲时是否显示":"true","失去护甲时是否显示":"true","护甲表示方式":"图标+文本","获得金钱时是否显示":"true","失去金钱时是否显示":"true","金钱表示方式":"图标+文本","---层级---":"","UI基准":"相对于镜头","地图层级":"图片层","地图图片层级":"80","---窗口皮肤---":"","布局模式":"默认窗口皮肤","布局透明度":"255","资源-自定义窗口皮肤":"Window","资源-自定义背景图片":"(需配置)临时漂浮文字-自定义背景图片","平移-自定义背景图片 X":"0","平移-自定义背景图片 Y":"0","是否锁定窗口色调":"false","窗口色调-红":"0","窗口色调-绿":"0","窗口色调-蓝":"0","---窗口属性---":"","窗口中心锚点":"右下角","窗口内边距":"10","窗口字体大小":"20","窗口附加宽度":"0","窗口附加高度":"0"}
 * 
 * @param 物品框样式-3
 * @parent ---样式组 1至20---
 * @type struct<DrillGFTHStyle>
 * @desc 漂浮文字的内容配置信息。
 * @default {"标签":"==默认皮肤_紫红==","---常规---":"","总持续时长":"480","移动时间":"20","移动方式":"匀速移动","偏移-物品框起点 X":"120","偏移-物品框起点 Y":"0","物品框间距":"2","推进方向":"向上","最大推进数量":"8","---物品框---":"","获得时数字的颜色":"24","失去时数字的颜色":"18","获得物品时是否显示":"true","失去物品时是否显示":"true","物品表示方式":"图标+文本","获得武器时是否显示":"true","失去武器时是否显示":"true","武器表示方式":"图标+文本","获得护甲时是否显示":"true","失去护甲时是否显示":"true","护甲表示方式":"图标+文本","获得金钱时是否显示":"true","失去金钱时是否显示":"true","金钱表示方式":"图标+文本","---层级---":"","UI基准":"相对于镜头","地图层级":"图片层","地图图片层级":"80","---窗口皮肤---":"","布局模式":"默认窗口皮肤","布局透明度":"255","资源-自定义窗口皮肤":"Window","资源-自定义背景图片":"(需配置)临时漂浮文字-自定义背景图片","平移-自定义背景图片 X":"0","平移-自定义背景图片 Y":"0","是否锁定窗口色调":"true","窗口色调-红":"-102","窗口色调-绿":"-221","窗口色调-蓝":"-102","---窗口属性---":"","窗口中心锚点":"右下角","窗口内边距":"10","窗口字体大小":"20","窗口附加宽度":"0","窗口附加高度":"0"}
 * 
 * @param 物品框样式-4
 * @parent ---样式组 1至20---
 * @type struct<DrillGFTHStyle>
 * @desc 漂浮文字的内容配置信息。
 * @default {"标签":"==默认皮肤_紫红+向左推进==","---常规---":"","总持续时长":"480","移动时间":"20","移动方式":"匀速移动","偏移-物品框起点 X":"120","偏移-物品框起点 Y":"0","物品框间距":"2","推进方向":"向左","最大推进数量":"5","---物品框---":"","获得时数字的颜色":"24","失去时数字的颜色":"18","获得物品时是否显示":"true","失去物品时是否显示":"true","物品表示方式":"图标+文本","获得武器时是否显示":"true","失去武器时是否显示":"true","武器表示方式":"图标+文本","获得护甲时是否显示":"true","失去护甲时是否显示":"true","护甲表示方式":"图标+文本","获得金钱时是否显示":"true","失去金钱时是否显示":"true","金钱表示方式":"图标+文本","---层级---":"","UI基准":"相对于镜头","地图层级":"图片层","地图图片层级":"80","---窗口皮肤---":"","布局模式":"默认窗口皮肤","布局透明度":"255","资源-自定义窗口皮肤":"Window","资源-自定义背景图片":"(需配置)临时漂浮文字-自定义背景图片","平移-自定义背景图片 X":"0","平移-自定义背景图片 Y":"0","是否锁定窗口色调":"true","窗口色调-红":"-102","窗口色调-绿":"-221","窗口色调-蓝":"-102","---窗口属性---":"","窗口中心锚点":"右下角","窗口内边距":"10","窗口字体大小":"20","窗口附加宽度":"0","窗口附加高度":"0"}
 * 
 * @param 物品框样式-5
 * @parent ---样式组 1至20---
 * @type struct<DrillGFTHStyle>
...
//=============================================================================
	...
	// * 提示信息 - 报错 - 窗口字符底层校验
	//==============================
	DrillUp.drill_GFTH_getPluginTip_NeedUpdate_drawText = function(){
...
Game_Interpreter.prototype.pluginCommand = function( command, args ){
	...
	this.drill_GFTH_pluginCommand( command, args );
}
//==============================
// * 插件指令 - 指令执行
//==============================
Game_Interpreter.prototype.drill_GFTH_pluginCommand = function( command, args ){
...
// * C窗口皮肤 - 帧刷新 - 高宽变化『窗口皮肤』
//==============================
Drill_GFTH_Window.prototype.drill_updateSkin_skinBackground = function() {
...
// * D窗口内容 - 刷新内容
//==============================
Drill_GFTH_Window.prototype.drill_refreshMessage = function( context ){
...
if( typeof(_drill_COWC_drawText_functionExist) == "undefined" ){
	alert( DrillUp.drill_GFTH_getPluginTip_NeedUpdate_drawText() );
}
