 ...
 * 细节：
 *   (1.插件直接管理底层的h5绘制系统。
 *      能在绘制字符前，就能提前知道字符的位置、宽度、高度，以此确定字符方框范围。
 * 
 * -----------------------------------------------------------------------------
 * ----可选设定 - Debug查看
 ...
 * 2.插件提供了一系列工具函数，只单次执行，将字符绘制在画布上。
 * 
 * -----------------------------------------------------------------------------
 * ----更新日志
 * [v1.0]
...
//		★性能测试因素	对话框管理层
//		★性能测试消耗	2025/4/30：
//							》2.4ms（drill_COCD_org_initBitmapDefault）1.5ms（drill_COCD_drawBaseText_Private）
//							》『TotalTime』：106.1ms（drill_COCD_drawTextBlock）89.1ms（drill_COCD_analysisText）
//		★最坏情况		暂无
//		★备注			暂无
//		
//		★优化记录		暂无
