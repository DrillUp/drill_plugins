...
//=============================================================================
	...
	// * 提示信息 - 报错 - 找不到样式
	//==============================
	DrillUp.drill_BCi_getPluginTip_StyleNotFind = function( style_id ){
...
Game_Interpreter.prototype.pluginCommand = function( command, args ){
	...
	this.drill_BCi_pluginCommand( command, args );
}
//==============================
// * 插件指令 - 指令执行
//==============================
Game_Interpreter.prototype.drill_BCi_pluginCommand = function( command, args ){
...
Drill_BCi_Controller.prototype.drill_data = function(){
	...
	if( cur_styleData == undefined ){
		...
		return Drill_BCi_Controller.emptyData;
	}
