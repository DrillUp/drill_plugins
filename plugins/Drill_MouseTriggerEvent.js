 ...
 * 可选设置：
 *   (1.默认右键会进入菜单，所以默认右键的功能被关闭。
 *      默认右键的功能在 系统-输入设备核心 插件中控制。
 ...
 *   注意，上述指令没写"悬停"二字，但实际功能有"悬停"条件。
 *   比如"左键按下[持续]"，需要悬停并左键按下，才能触发独立开关。
 *   上述指令实际功能来自 物体-鼠标悬停响应开关 插件。
 * 2.由于注释设置全部跨事件页，也就是说 鼠标触发 与 事件对象 一一绑定，
