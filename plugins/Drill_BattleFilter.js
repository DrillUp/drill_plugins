 ...
 * 1.插件的作用域：战斗界面。
 *   作用于战斗 图片层 以下的所有层。
 * 2.想要了解更多滤镜效果，可以去看看 "1.系统 > 滤镜效果大家族.docx"。
 * 滤镜：
...
// ** 存储数据初始化
//=============================================================================
var _drill_BFi_filterTankystem_initialize = Game_System.prototype.initialize;
Game_System.prototype.initialize = function() {
    _drill_BFi_filterTankystem_initialize.call(this);
	this._drill_BFi = {};
