 ...
 * -----------------------------------------------------------------------------
 * ----可选设定 - 启用/禁用
 * 你可以通过插件指令控制菜单平铺GIF的启用情况：
 * 
 * 插件指令：>菜单平铺GIF : 平铺GIF[2] : 启用
 * 插件指令：>菜单平铺GIF : 平铺GIF[2] : 禁用
 * 插件指令：>菜单平铺GIF : 批量平铺GIF[2,3] : 启用
 * 插件指令：>菜单平铺GIF : 批量平铺GIF[2,3] : 禁用
 * 
 * 1.数字表示平铺GIF对应配置的编号。
 ...
 * 你可以通过插件指令手动延迟修改各个属性：
 * 
 * 插件指令：>菜单平铺GIF : 平铺GIF[11] : 隐藏(延迟) : 延迟执行时间[20]
 * 插件指令：>菜单平铺GIF : 平铺GIF变量[21] : 隐藏(延迟) : 延迟执行时间[20]
 * 插件指令：>菜单平铺GIF : 批量平铺GIF[7,8] : 隐藏(延迟) : 延迟执行时间[20]
 * 插件指令：>菜单平铺GIF : 批量平铺GIF变量[21,22] : 隐藏(延迟) : 延迟执行时间[20]
 * 
 * 插件指令：>菜单平铺GIF : 平铺GIF[11] : 显示(延迟) : 延迟执行时间[20]
 * 插件指令：>菜单平铺GIF : 平铺GIF[11] : 隐藏(延迟) : 延迟执行时间[20]
 * 插件指令：>菜单平铺GIF : 平铺GIF[11] : 暂停(延迟) : 延迟执行时间[20]
 * 插件指令：>菜单平铺GIF : 平铺GIF[11] : 继续(延迟) : 延迟执行时间[20]
 * 插件指令：>菜单平铺GIF : 平铺GIF[11] : 切换混合模式(延迟)[0] : 延迟执行时间[20]
 * 插件指令：>菜单平铺GIF : 平铺GIF[11] : 还原混合模式(延迟) : 延迟执行时间[20]
 * 插件指令：>菜单平铺GIF : 平铺GIF[11] : 切换菜单层级(延迟)[菜单前面层] : 延迟执行时间[20]
 * 插件指令：>菜单平铺GIF : 平铺GIF[11] : 还原菜单层级(延迟) : 延迟执行时间[20]
 * 插件指令：>菜单平铺GIF : 平铺GIF[11] : 切换图片层级(延迟)[10] : 延迟执行时间[20]
 * 插件指令：>菜单平铺GIF : 平铺GIF[11] : 还原图片层级(延迟) : 延迟执行时间[20]
 * 插件指令：>菜单平铺GIF : 平铺GIF[11] : 修改单属性(延迟) : 透明度[255] : 时间[60] : 延迟执行时间[20]
 * 插件指令：>菜单平铺GIF : 平铺GIF[11] : 修改单属性(延迟) : 透明度变量[21] : 时间[60] : 延迟执行时间[20]
 * 插件指令：>菜单平铺GIF : 平铺GIF[11] : 修改单属性(延迟) : 旋转[90] : 时间[60] : 延迟执行时间[20]
 * 插件指令：>菜单平铺GIF : 平铺GIF[11] : 修改单属性(延迟) : 旋转变量[21] : 时间[60] : 延迟执行时间[20]
 * 插件指令：>菜单平铺GIF : 平铺GIF[11] : 修改单属性(延迟) : 移动速度X[1.5] : 时间[60] : 延迟执行时间[20]
 * 插件指令：>菜单平铺GIF : 平铺GIF[11] : 修改单属性(延迟) : 移动速度X变量%[21] : 时间[60] : 延迟执行时间[20]
 * 插件指令：>菜单平铺GIF : 平铺GIF[11] : 修改单属性(延迟) : 移动速度Y[1.5] : 时间[60] : 延迟执行时间[20]
 * 插件指令：>菜单平铺GIF : 平铺GIF[11] : 修改单属性(延迟) : 移动速度Y变量%[21] : 时间[60] : 延迟执行时间[20]
 * 插件指令：>菜单平铺GIF : 平铺GIF[11] : 修改单属性(延迟) : 缩放X[1.2] : 时间[60] : 延迟执行时间[20]
 * 插件指令：>菜单平铺GIF : 平铺GIF[11] : 修改单属性(延迟) : 缩放X变量%[21] : 时间[60] : 延迟执行时间[20]
 * 插件指令：>菜单平铺GIF : 平铺GIF[11] : 修改单属性(延迟) : 缩放Y[1.2] : 时间[60] : 延迟执行时间[20]
 * 插件指令：>菜单平铺GIF : 平铺GIF[11] : 修改单属性(延迟) : 缩放Y变量%[21] : 时间[60] : 延迟执行时间[20]
 * 插件指令：>菜单平铺GIF : 平铺GIF[11] : 修改单属性(延迟) : 斜切X[0.2] : 时间[60] : 延迟执行时间[20]
 * 插件指令：>菜单平铺GIF : 平铺GIF[11] : 修改单属性(延迟) : 斜切X变量%[21] : 时间[60] : 延迟执行时间[20]
 * 插件指令：>菜单平铺GIF : 平铺GIF[11] : 修改单属性(延迟) : 斜切Y[0.2] : 时间[60] : 延迟执行时间[20]
 * 插件指令：>菜单平铺GIF : 平铺GIF[11] : 修改单属性(延迟) : 斜切Y变量%[21] : 时间[60] : 延迟执行时间[20]
 * 插件指令：>菜单平铺GIF : 平铺GIF[11] : 还原所有单属性(延迟) : 延迟执行时间[20]
 * 插件指令：>菜单平铺GIF : 平铺GIF[11] : 清空菜单的延迟指令列表
 * 
 * 1.前半部分（平铺GIF变量[21]）和 后半部分（隐藏(延迟) : 延迟执行时间[20]）
 ...
 * 你可以通过插件指令手动设置延迟移动：
 * 
 * 插件指令：>菜单平铺GIF : 平铺GIF[11] : 移动到(延迟)-匀速移动 : 位置[100,100] : 时间[60] : 延迟执行时间[20]
 * 插件指令：>菜单平铺GIF : 平铺GIF[11] : 移动到(延迟)-匀速移动 : 位置变量[25,26] : 时间[60] : 延迟执行时间[20]
 * 插件指令：>菜单平铺GIF : 平铺GIF[11] : 移动到(延迟)-弹性移动 : 位置[100,100] : 时间[60] : 延迟执行时间[20]
 * 插件指令：>菜单平铺GIF : 平铺GIF[11] : 移动到(延迟)-弹性移动 : 位置变量[25,26] : 时间[60] : 延迟执行时间[20]
 * 插件指令：>菜单平铺GIF : 平铺GIF[11] : 移动到(延迟)-增减速移动 : 位置[100,100] : 时间[60] : 延迟执行时间[20]
 * 插件指令：>菜单平铺GIF : 平铺GIF[11] : 移动到(延迟)-增减速移动 : 位置变量[25,26] : 时间[60] : 延迟执行时间[20]
 * 插件指令：>菜单平铺GIF : 平铺GIF[11] : 移动到(延迟)-延迟归位 : 延迟执行时间[20]
 * 
 ...
 *   每进入到菜单界面一次，指令都会生效一次。
 *   插件指令在地图界面中预先执行，进入到菜单界面之后，延迟时间才开始计时。
 *   "清空菜单的延迟指令列表"可以清空排在列表中的所有"平铺GIF[11]"的延迟指令。
 * 
 * -----------------------------------------------------------------------------
 * ----可选设定 - 延迟GIF播放
 * 你还可以通过插件指令控制延迟GIF播放：
 * 
 * 插件指令：>菜单平铺GIF : 平铺GIF[11] : 锁定帧(延迟) : 延迟执行时间[20]
 * 插件指令：>菜单平铺GIF : 平铺GIF[11] : 解锁帧(延迟) : 延迟执行时间[20]
 * 插件指令：>菜单平铺GIF : 平铺GIF[11] : 设置帧(延迟) : 当前帧[1] : 延迟执行时间[20]
 * 插件指令：>菜单平铺GIF : 平铺GIF[11] : 设置帧(延迟) : 当前帧变量[21] : 延迟执行时间[20]
 * 插件指令：>菜单平铺GIF : 平铺GIF[11] : 正向播放一次并停留在末尾帧(延迟) : 延迟执行时间[20]
 * 插件指令：>菜单平铺GIF : 平铺GIF[11] : 反向播放一次并停留在起始帧(延迟) : 延迟执行时间[20]
 * 
 ...
 * 
 * 插件指令：>菜单平铺GIF : 平铺GIF[11] : 添加周期-隐藏(周期) : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>菜单平铺GIF : 平铺GIF变量[21] : 添加周期-隐藏(周期) : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>菜单平铺GIF : 批量平铺GIF[7,8] : 添加周期-隐藏(周期) : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>菜单平铺GIF : 批量平铺GIF变量[21,22] : 添加周期-隐藏(周期) : 周期时长[90] : 周期内开始时间[0]
 * 
 * 插件指令：>菜单平铺GIF : 平铺GIF[11] : 添加周期-显示(周期) : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>菜单平铺GIF : 平铺GIF[11] : 添加周期-隐藏(周期) : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>菜单平铺GIF : 平铺GIF[11] : 添加周期-暂停(周期) : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>菜单平铺GIF : 平铺GIF[11] : 添加周期-继续(周期) : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>菜单平铺GIF : 平铺GIF[11] : 添加周期-切换混合模式(周期)[0] : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>菜单平铺GIF : 平铺GIF[11] : 添加周期-还原混合模式(周期) : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>菜单平铺GIF : 平铺GIF[11] : 添加周期-切换菜单层级(周期)[菜单前面层] : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>菜单平铺GIF : 平铺GIF[11] : 添加周期-还原菜单层级(周期) : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>菜单平铺GIF : 平铺GIF[11] : 添加周期-切换图片层级(周期)[10] : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>菜单平铺GIF : 平铺GIF[11] : 添加周期-还原图片层级(周期) : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>菜单平铺GIF : 平铺GIF[11] : 添加周期-修改单属性(周期) : 透明度[255] : 时间[60] : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>菜单平铺GIF : 平铺GIF[11] : 添加周期-修改单属性(周期) : 透明度变量[21] : 时间[60] : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>菜单平铺GIF : 平铺GIF[11] : 添加周期-修改单属性(周期) : 旋转[90] : 时间[60] : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>菜单平铺GIF : 平铺GIF[11] : 添加周期-修改单属性(周期) : 旋转变量[21] : 时间[60] : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>菜单平铺GIF : 平铺GIF[11] : 添加周期-修改单属性(周期) : 移动速度X[1.5] : 时间[60] : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>菜单平铺GIF : 平铺GIF[11] : 添加周期-修改单属性(周期) : 移动速度X变量%[21] : 时间[60] : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>菜单平铺GIF : 平铺GIF[11] : 添加周期-修改单属性(周期) : 移动速度Y[1.5] : 时间[60] : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>菜单平铺GIF : 平铺GIF[11] : 添加周期-修改单属性(周期) : 移动速度Y变量%[21] : 时间[60] : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>菜单平铺GIF : 平铺GIF[11] : 添加周期-修改单属性(周期) : 缩放X[1.2] : 时间[60] : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>菜单平铺GIF : 平铺GIF[11] : 添加周期-修改单属性(周期) : 缩放X变量%[21] : 时间[60] : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>菜单平铺GIF : 平铺GIF[11] : 添加周期-修改单属性(周期) : 缩放Y[1.2] : 时间[60] : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>菜单平铺GIF : 平铺GIF[11] : 添加周期-修改单属性(周期) : 缩放Y变量%[21] : 时间[60] : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>菜单平铺GIF : 平铺GIF[11] : 添加周期-修改单属性(周期) : 斜切X[0.2] : 时间[60] : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>菜单平铺GIF : 平铺GIF[11] : 添加周期-修改单属性(周期) : 斜切X变量%[21] : 时间[60] : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>菜单平铺GIF : 平铺GIF[11] : 添加周期-修改单属性(周期) : 斜切Y[0.2] : 时间[60] : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>菜单平铺GIF : 平铺GIF[11] : 添加周期-修改单属性(周期) : 斜切Y变量%[21] : 时间[60] : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>菜单平铺GIF : 平铺GIF[11] : 添加周期-还原所有单属性(周期) : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>菜单平铺GIF : 平铺GIF[11] : 清空菜单的周期指令列表
 * 
 ...
 *   每进入到菜单界面一次，指令都会生效一次。
 *   "清空菜单的周期指令列表"可以清空排在列表中的所有"平铺GIF[11]"的周期指令。
 * 
 * -----------------------------------------------------------------------------
 * ----可选设定 - 周期移动到
 * 上述的插件指令中，移动到的插件指令也可以周期执行：
 * 
 * 插件指令：>菜单平铺GIF : 平铺GIF[11] : 添加周期-移动到(周期)-匀速移动 : 位置[100,100] : 时间[60] : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>菜单平铺GIF : 平铺GIF[11] : 添加周期-移动到(周期)-匀速移动 : 位置变量[25,26] : 时间[60] : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>菜单平铺GIF : 平铺GIF[11] : 添加周期-移动到(周期)-弹性移动 : 位置[100,100] : 时间[60] : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>菜单平铺GIF : 平铺GIF[11] : 添加周期-移动到(周期)-弹性移动 : 位置变量[25,26] : 时间[60] : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>菜单平铺GIF : 平铺GIF[11] : 添加周期-移动到(周期)-增减速移动 : 位置[100,100] : 时间[60] : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>菜单平铺GIF : 平铺GIF[11] : 添加周期-移动到(周期)-增减速移动 : 位置变量[25,26] : 时间[60] : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>菜单平铺GIF : 平铺GIF[11] : 添加周期-移动到(周期)-执行归位 : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>菜单平铺GIF : 平铺GIF[11] : 清空菜单的周期指令列表
 * 
 ...
 * 
 * 插件指令：>菜单平铺GIF : 平铺GIF[11] : 添加周期-锁定帧(周期) : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>菜单平铺GIF : 平铺GIF[11] : 添加周期-解锁帧(周期) : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>菜单平铺GIF : 平铺GIF[11] : 添加周期-设置帧(周期) : 当前帧[1] : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>菜单平铺GIF : 平铺GIF[11] : 添加周期-设置帧(周期) : 当前帧变量[21] : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>菜单平铺GIF : 平铺GIF[11] : 清空菜单的周期指令列表
 * 
 ...
 * 上述的插件指令中，可以设置：
 * 
 * 插件指令：>菜单平铺GIF : 平铺GIF[11] : 暂停周期指令(延迟) : 延迟执行时间[20]
 * 插件指令：>菜单平铺GIF : 平铺GIF[11] : 继续周期指令(延迟) : 延迟执行时间[20]
 * 插件指令：>菜单平铺GIF : 平铺GIF[11] : 清空周期指令(延迟) : 延迟执行时间[20]
 * 
...
Game_Interpreter.prototype.drill_MTG_pluginCommand = function( command, args ){
	DrillUp.drill_MTG_globalPluginCommand( command, args, this );
}
//==============================
// * 插件指令 - 『作用全局的插件指令』
//
...
//==============================
DrillUp.drill_MTG_globalPluginCommand = function( command, args, gameInterpreter ){
	if( command === ">菜单平铺GIF" ){
		...
		if( args.length == 4 ){
			...
			if( type === "启用" || type === "显示" ){
				for(var i = 0; i < style_id_list.length; i++ ){
					$gameSystem._drill_MTG_enableTank[ Number(style_id_list[i]) ] = true;
				}
				return;
			}
			if( type === "禁用" || type === "隐藏" ){
				for(var i = 0; i < style_id_list.length; i++ ){
					$gameSystem._drill_MTG_enableTank[ Number(style_id_list[i]) ] = false;
				}
				return;
			}
		}
		...
		if( args.length >= 2 ){
			var unit = String(args[1]);
			if( controller_id_list == null && unit.indexOf("批量平铺GIF[") != -1 ){
				unit = unit.replace("批量平铺GIF[","");
				unit = unit.replace("]","");
				controller_id_list = [];
				var temp_arr = unit.split(/[,，]/);
			...
			if( controller_id_list == null && unit.indexOf("批量平铺GIF变量[") != -1 ){
			...
			if( controller_id_list == null && unit.indexOf("平铺GIF变量[") != -1 ){
			...
			if( controller_id_list == null && unit.indexOf("平铺GIF[") != -1 ){
				unit = unit.replace("平铺GIF[","");
				unit = unit.replace("]","");
		...
		if( args.length == 4 ){
			...
			if( type == "清空菜单的延迟指令列表" ){
				for( var k=0; k < controller_id_list.length; k++ ){
					$gameSystem.drill_MTG_sys_clearDelayingCommand( controller_id_list[k] );
				}
			}
		}
		//if( args.length == 6 ){
		...
		if( args.length == 6 ){
			...
			if( type == "显示(延迟)" ){
				...
				for( var k=0; k < controller_id_list.length; k++ ){
					$gameSystem.drill_MTG_sys_addDelayingCommand( controller_id_list[k],
						Drill_MTG_Controller.METHOD__drill_controller_setVisible, [true], delay_time
					);
				}
			}
			if( type == "隐藏(延迟)" ){
				...
				for( var k=0; k < controller_id_list.length; k++ ){
					$gameSystem.drill_MTG_sys_addDelayingCommand( controller_id_list[k],
						Drill_MTG_Controller.METHOD__drill_controller_setVisible, [false], delay_time
					);
				}
			}
			if( type == "暂停(延迟)" ){
				...
				for( var k=0; k < controller_id_list.length; k++ ){
					$gameSystem.drill_MTG_sys_addDelayingCommand( controller_id_list[k],
						Drill_MTG_Controller.METHOD__drill_controller_setPause, [true], delay_time
					);
				}
			}
			if( type == "继续(延迟)" ){
				...
				for( var k=0; k < controller_id_list.length; k++ ){
					$gameSystem.drill_MTG_sys_addDelayingCommand( controller_id_list[k],
						Drill_MTG_Controller.METHOD__drill_controller_setPause, [false], delay_time
					);
				}
			}
			if( type == "暂停周期指令(延迟)" ){
				...
				for( var k=0; k < controller_id_list.length; k++ ){
					$gameSystem.drill_MTG_sys_addDelayingCommand( controller_id_list[k],
						Drill_MTG_Controller.METHOD__drill_controller_periodizeCommand_setPause, [true], delay_time
					);
				}
			}
			if( type == "继续周期指令(延迟)" ){
				...
				for( var k=0; k < controller_id_list.length; k++ ){
					$gameSystem.drill_MTG_sys_addDelayingCommand( controller_id_list[k],
						Drill_MTG_Controller.METHOD__drill_controller_periodizeCommand_setPause, [false], delay_time
					);
				}
			}
			if( type == "清空周期指令(延迟)" ){
				...
				for( var k=0; k < controllers.length; k++ ){
					$gameSystem.drill_MTG_sys_addDelayingCommand( controller_id_list[k],
						Drill_MTG_Controller.METHOD__drill_controller_periodizeCommand_clear, [], delay_time
					);
				}
			}
			...
			if( type.indexOf("切换混合模式(延迟)[") != -1 ){
				...
				for( var k=0; k < controller_id_list.length; k++ ){
					$gameSystem.drill_MTG_sys_addDelayingCommand( controller_id_list[k],
						Drill_MTG_Controller.METHOD__drill_controller_setBlendMode, [Number(type)], delay_time
					);
				}
			}
			if( type.indexOf("切换菜单层级(延迟)[") != -1 ){
				...
				for( var k=0; k < controller_id_list.length; k++ ){
					$gameSystem.drill_MTG_sys_addDelayingCommand( controller_id_list[k],
						Drill_MTG_Controller.METHOD__drill_controller_setLayerIndex, [String(type)], delay_time
					);
				}
			}
			if( type.indexOf("切换图片层级(延迟)[") != -1 ){
				...
				for( var k=0; k < controller_id_list.length; k++ ){
					$gameSystem.drill_MTG_sys_addDelayingCommand( controller_id_list[k],
						Drill_MTG_Controller.METHOD__drill_controller_setZIndex, [Number(type)], delay_time
					);
				}
			}
			if( type == "还原混合模式(延迟)" ){
				...
				for( var k=0; k < controllers.length; k++ ){
					$gameSystem.drill_MTG_sys_addDelayingCommand( controller_id_list[k],
						Drill_MTG_Controller.METHOD__drill_controller_restoreBlendMode, [], delay_time
					);
				}
			}
			if( type == "还原菜单层级(延迟)" ){
				...
				for( var k=0; k < controllers.length; k++ ){
					$gameSystem.drill_MTG_sys_addDelayingCommand( controller_id_list[k],
						Drill_MTG_Controller.METHOD__drill_controller_restoreLayerIndex, [], delay_time
					);
				}
			}
			if( type == "还原图片层级(延迟)" ){
				...
				for( var k=0; k < controllers.length; k++ ){
					$gameSystem.drill_MTG_sys_addDelayingCommand( controller_id_list[k],
						Drill_MTG_Controller.METHOD__drill_controller_restoreZIndex, [], delay_time
					);
				}
			}
			if( type == "还原所有单属性(延迟)" ){
				...
				for( var k=0; k < controller_id_list.length; k++ ){
					$gameSystem.drill_MTG_sys_addDelayingCommand( controller_id_list[k],
						Drill_MTG_Controller.METHOD__drill_controller_commandChange_restoreAttr, [], delay_time
					);
				}
			}
			if( type == "移动到(延迟)-延迟归位" ){
				...
				for( var k=0; k < controller_id_list.length; k++ ){
					$gameSystem.drill_MTG_sys_addDelayingCommand( controller_id_list[k],
						Drill_MTG_Controller.METHOD__drill_controller_commandChange_restoreMove, [], delay_time
					);
				}
			}
		}
		if( args.length == 10 ){
			...
			if( type == "修改单属性(延迟)" ){
				...
				if( temp1.indexOf("透明度[") != -1 ||
					...
					var num_list = DrillUp.drill_MTG_getArgNumList(temp1);
					for( var k=0; k < controller_id_list.length; k++ ){
						$gameSystem.drill_MTG_sys_addDelayingCommand( controller_id_list[k],
							Drill_MTG_Controller.METHOD__drill_controller_commandChange_setOpacity, 
				...
				if( temp1.indexOf("旋转[") != -1 ||
					...
					for( var k=0; k < controller_id_list.length; k++ ){
						$gameSystem.drill_MTG_sys_addDelayingCommand( controller_id_list[k],
							Drill_MTG_Controller.METHOD__drill_controller_commandChange_setRotate,
							[ "匀速变化", num_list[0], Number(temp2) ], delay_time
						);
					}
				}
				if( temp1.indexOf("移动速度X[") != -1 ||
					...
					for( var k=0; k < controller_id_list.length; k++ ){
						$gameSystem.drill_MTG_sys_addDelayingCommand( controller_id_list[k],
							Drill_MTG_Controller.METHOD__drill_controller_commandChange_setSpeedX,
							["匀速变化", num_list[0], Number(temp2) ], delay_time
						);
					}
				}
				if( temp1.indexOf("移动速度Y[") != -1 ||
					...
					for( var k=0; k < controller_id_list.length; k++ ){
						$gameSystem.drill_MTG_sys_addDelayingCommand( controller_id_list[k],
							Drill_MTG_Controller.METHOD__drill_controller_commandChange_setSpeedY,
							["匀速变化", num_list[0], Number(temp2) ], delay_time
						);
					}
				}
				if( temp1.indexOf("缩放X[") != -1 ||
					...
					for( var k=0; k < controller_id_list.length; k++ ){
						$gameSystem.drill_MTG_sys_addDelayingCommand( controller_id_list[k],
							Drill_MTG_Controller.METHOD__drill_controller_commandChange_setScaleX,
							[ "匀速变化", num_list[0], Number(temp2) ], delay_time
						);
					}
				}
				if( temp1.indexOf("缩放Y[") != -1 ||
					...
					for( var k=0; k < controller_id_list.length; k++ ){
						$gameSystem.drill_MTG_sys_addDelayingCommand( controller_id_list[k],
							Drill_MTG_Controller.METHOD__drill_controller_commandChange_setScaleY,
							[ "匀速变化", num_list[0], Number(temp2) ], delay_time
						);
					}
				}
				if( temp1.indexOf("斜切X[") != -1 ||
					...
					for( var k=0; k < controller_id_list.length; k++ ){
						$gameSystem.drill_MTG_sys_addDelayingCommand( controller_id_list[k],
							Drill_MTG_Controller.METHOD__drill_controller_commandChange_setSkewX,
							[ "匀速变化", num_list[0], Number(temp2) ], delay_time
						);
					}
				}
				if( temp1.indexOf("斜切Y[") != -1 ||
					...
					for( var k=0; k < controller_id_list.length; k++ ){
						$gameSystem.drill_MTG_sys_addDelayingCommand( controller_id_list[k],
							Drill_MTG_Controller.METHOD__drill_controller_commandChange_setSkewY,
							[ "匀速变化", num_list[0], Number(temp2) ], delay_time
						);
					}
				}
			...
			if( type == "移动到(延迟)-匀速移动" ){
				...
				if( temp1.indexOf("位置[") != -1 ||
					...
					for( var k=0; k < controller_id_list.length; k++ ){
						$gameSystem.drill_MTG_sys_addDelayingCommand( controller_id_list[k],
							Drill_MTG_Controller.METHOD__drill_controller_commandChange_setMove,
		...
		if( args.length == 6 ){
			...
			if( type == "锁定帧(延迟)" ){
				for( var k=0; k < controllers.length; k++ ){
					$gameSystem.drill_MTG_sys_addDelayingCommand( controller_id_list[k],
						Drill_MTG_Controller.METHOD__drill_controller_GIF_setLocked,
						[ true ], delay_time
					);
				}
			}
			...
			if( type == "正向播放一次并停留在末尾帧(延迟)" ){
				for( var k=0; k < controllers.length; k++ ){
					$gameSystem.drill_MTG_sys_addDelayingCommand( controller_id_list[k],
						Drill_MTG_Controller.METHOD__drill_controller_GIF_setOncePlay,
		...
		if( args.length == 8 ){
			...
			if( type == "设置帧(延迟)" || type == "设置当前帧(延迟)" ){
				for( var k=0; k < controllers.length; k++ ){
					$gameSystem.drill_MTG_sys_addDelayingCommand( controller_id_list[k],
						Drill_MTG_Controller.METHOD__drill_controller_GIF_setFrame,
		...
		if( args.length == 4 ){
			...
			if( type == "清空菜单的周期指令列表" ){
				for( var k=0; k < controller_id_list.length; k++ ){
					$gameSystem.drill_MTG_sys_clearPeriodizeCommand( controller_id_list[k] );
				}
			}
		}
		if( args.length == 8 ){
			...
			if( type == "添加周期-显示(周期)" ){
				...
				for( var k=0; k < controller_id_list.length; k++ ){
					$gameSystem.drill_MTG_sys_addPeriodizeCommand( controller_id_list[k],
						Drill_MTG_Controller.METHOD__drill_controller_setVisible, [true], time_period, time_start
					);
				}
			}
			if( type == "添加周期-隐藏(周期)" ){
				...
				for( var k=0; k < controller_id_list.length; k++ ){
					$gameSystem.drill_MTG_sys_addPeriodizeCommand( controller_id_list[k],
						Drill_MTG_Controller.METHOD__drill_controller_setVisible, [false], time_period, time_start
					);
				}
			}
			if( type == "添加周期-暂停(周期)" ){
				...
				for( var k=0; k < controller_id_list.length; k++ ){
					$gameSystem.drill_MTG_sys_addPeriodizeCommand( controller_id_list[k],
						Drill_MTG_Controller.METHOD__drill_controller_setPause, [true], time_period, time_start
					);
				}
			}
			if( type == "添加周期-继续(周期)" ){
				...
				for( var k=0; k < controller_id_list.length; k++ ){
					$gameSystem.drill_MTG_sys_addPeriodizeCommand( controller_id_list[k],
						Drill_MTG_Controller.METHOD__drill_controller_setPause, [false], time_period, time_start
					);
				}
			}
			if( type.indexOf("添加周期-切换混合模式(周期)[") != -1 ){
				...
				for( var k=0; k < controller_id_list.length; k++ ){
					$gameSystem.drill_MTG_sys_addPeriodizeCommand( controller_id_list[k],
						Drill_MTG_Controller.METHOD__drill_controller_setBlendMode, [Number(type)], time_period, time_start
					);
				}
			}
			if( type.indexOf("添加周期-切换菜单层级(周期)[") != -1 ){
				...
				for( var k=0; k < controller_id_list.length; k++ ){
					$gameSystem.drill_MTG_sys_addPeriodizeCommand( controller_id_list[k],
						Drill_MTG_Controller.METHOD__drill_controller_setLayerIndex, [String(type)], time_period, time_start
					);
				}
			}
			if( type.indexOf("添加周期-切换图片层级(周期)[") != -1 ){
				...
				for( var k=0; k < controller_id_list.length; k++ ){
					$gameSystem.drill_MTG_sys_addPeriodizeCommand( controller_id_list[k],
						Drill_MTG_Controller.METHOD__drill_controller_setZIndex, [Number(type)], time_period, time_start
					);
				}
			}
			if( type == "添加周期-还原混合模式(周期)" ){
				...
				for( var k=0; k < controllers.length; k++ ){
					$gameSystem.drill_MTG_sys_addPeriodizeCommand( controller_id_list[k],
						Drill_MTG_Controller.METHOD__drill_controller_restoreBlendMode, [], time_period, time_start
					);
				}
			}
			if( type == "添加周期-还原菜单层级(周期)" ){
				...
				for( var k=0; k < controllers.length; k++ ){
					$gameSystem.drill_MTG_sys_addPeriodizeCommand( controller_id_list[k],
						Drill_MTG_Controller.METHOD__drill_controller_restoreLayerIndex, [], time_period, time_start
					);
				}
			}
			if( type == "添加周期-还原图片层级(周期)" ){
				...
				for( var k=0; k < controllers.length; k++ ){
					$gameSystem.drill_MTG_sys_addPeriodizeCommand( controller_id_list[k],
						Drill_MTG_Controller.METHOD__drill_controller_restoreZIndex, [], time_period, time_start
					);
				}
			}
			if( type == "添加周期-还原所有单属性(周期)" ){
				...
				for( var k=0; k < controller_id_list.length; k++ ){
					$gameSystem.drill_MTG_sys_addPeriodizeCommand( controller_id_list[k],
						Drill_MTG_Controller.METHOD__drill_controller_commandChange_restoreAttr, [], time_period, time_start
					);
				}
			}
			if( type == "添加周期-移动到(周期)-执行归位" ){
				...
				for( var k=0; k < controller_id_list.length; k++ ){
					$gameSystem.drill_MTG_sys_addPeriodizeCommand( controller_id_list[k],
						Drill_MTG_Controller.METHOD__drill_controller_commandChange_restoreMove, [], time_period, time_start
					);
				}
			}
		}
...
//==============================
DrillUp.drill_MTG_getArgNumList = function( arg_str ){
...
Game_System.prototype.drill_MTG_initSysData_Private = function() {
	...
	this._drill_MTG_enableTank = [];				//启用/禁用
	for( var i = 0; i < DrillUp.g_MTG_style.length; i++ ){
		var temp_data = DrillUp.g_MTG_style[i];
		if( temp_data == undefined ){ continue; }
		this._drill_MTG_enableTank[i] = temp_data['enable'];
	}
	
	this._drill_MTG_DelayingCommandTank = [];		//中转指令容器（延时指令）
	this._drill_MTG_PeriodizeCommandTank = [];		//中转指令容器（周期指令）
};
//==============================
// * 存储数据 - 载入存档时检查数据（私有）
//==============================
Game_System.prototype.drill_MTG_checkSysData_Private = function() {
	...
	// > 旧存档数据自动补充
	if( this._drill_MTG_enableTank == undefined ){
		this.drill_MTG_initSysData();
	}
	...
	for(var i = 0; i < DrillUp.g_MTG_style.length; i++ ){
		...
		if( temp_data != undefined ){
			...
			// > 未存储的，重新初始化
			if( this._drill_MTG_enableTank[i] == undefined ){
				this._drill_MTG_enableTank[i] = temp_data['enable'];
...
Scene_MenuBase.prototype.drill_MTG_create = function() {	
	...
	for( var i = 0; i < DrillUp.g_MTG_style.length; i++ ){
		...
		// > 配置的数据 - 检查启用
		if( $gameSystem._drill_MTG_enableTank[ i ] === false ){ continue; }
...
// * 中转指令容器 - 加入延时指令（开放函数）
//==============================
Game_System.prototype.drill_MTG_sys_addDelayingCommand = function( controller_id, method, paramList, delay_time ){
	/*
		该函数用于中转，进入菜单界面后（这时候才创建controller），
		才执行 controller.drill_controller_setDelayingCommand( method, paramList, delay_time );
	*/
	if( this._drill_MTG_DelayingCommandTank[controller_id] == undefined ){
		this._drill_MTG_DelayingCommandTank[controller_id] = [];  //（注意，控制器内还能放多条指令）
	}
	var method_data = {};
	method_data['method'] = method;
	method_data['paramList'] = paramList;
	method_data['delay_time'] = delay_time;
	this._drill_MTG_DelayingCommandTank[controller_id].push( method_data );
};
//==============================
// * 中转指令容器 - 清空延时指令（开放函数）
//==============================
Game_System.prototype.drill_MTG_sys_clearDelayingCommand = function( controller_id ){
	this._drill_MTG_DelayingCommandTank[controller_id] = undefined;
};
//==============================
// * 中转指令容器 - 加入周期指令（开放函数）
//==============================
Game_System.prototype.drill_MTG_sys_addPeriodizeCommand = function( controller_id, method, paramList, time_period, time_start ){
	/*
		该函数用于中转，进入菜单界面后（这时候才创建controller），
		才执行 controller.drill_controller_setPeriodizeCommand( method, paramList, time_period, time_start );
	*/
	if( this._drill_MTG_PeriodizeCommandTank[controller_id] == undefined ){
		this._drill_MTG_PeriodizeCommandTank[controller_id] = [];  //（注意，控制器内还能放多条指令）
	}
	var method_data = {};
	method_data['method'] = method;
	method_data['paramList'] = paramList;
	...
	this._drill_MTG_PeriodizeCommandTank[controller_id].push( method_data );
};
//==============================
// * 中转指令容器 - 清空周期指令（开放函数）
//==============================
Game_System.prototype.drill_MTG_sys_clearPeriodizeCommand = function( controller_id ){
	this._drill_MTG_PeriodizeCommandTank[controller_id] = undefined;
};
//==============================
// * 中转指令容器 - 控制器初始化
//==============================
var _drill_MTG_MTG_create = Scene_MenuBase.prototype.drill_MTG_create;
Scene_MenuBase.prototype.drill_MTG_create = function() {
	_drill_MTG_MTG_create.call(this);
	
	for( var i = 0; i < this._drill_MTG_controllerTank.length; i++ ){
		var controller = this._drill_MTG_controllerTank[i];
		var controller_id = controller._drill_data_id;
		
		// > 延时指令
		var delayingCommand_tank = $gameSystem._drill_MTG_DelayingCommandTank[ controller_id ];
		...
		// > 周期指令
		var periodizeCommand_tank = $gameSystem._drill_MTG_PeriodizeCommandTank[ controller_id ];
...
//==============================
Drill_MTG_Controller.METHOD__drill_controller_setVisible                   = 11;
Drill_MTG_Controller.METHOD__drill_controller_setPause                     = 12;
Drill_MTG_Controller.METHOD__drill_controller_periodizeCommand_setPause    = 13;
Drill_MTG_Controller.METHOD__drill_controller_periodizeCommand_clear       = 14;

Drill_MTG_Controller.METHOD__drill_controller_setBlendMode                 = 21;
Drill_MTG_Controller.METHOD__drill_controller_setLayerIndex                = 22;
Drill_MTG_Controller.METHOD__drill_controller_setZIndex                    = 23;
Drill_MTG_Controller.METHOD__drill_controller_restoreBlendMode             = 24;
Drill_MTG_Controller.METHOD__drill_controller_restoreLayerIndex            = 25;
Drill_MTG_Controller.METHOD__drill_controller_restoreZIndex                = 26;

Drill_MTG_Controller.METHOD__drill_controller_commandChange_setOpacity     = 31;
Drill_MTG_Controller.METHOD__drill_controller_commandChange_setSpeedX      = 32;
Drill_MTG_Controller.METHOD__drill_controller_commandChange_setSpeedY      = 33;
Drill_MTG_Controller.METHOD__drill_controller_commandChange_setRotate      = 34;

Drill_MTG_Controller.METHOD__drill_controller_commandChange_setScaleX      = 41;
Drill_MTG_Controller.METHOD__drill_controller_commandChange_setScaleY      = 42;
Drill_MTG_Controller.METHOD__drill_controller_commandChange_setSkewX       = 43;
Drill_MTG_Controller.METHOD__drill_controller_commandChange_setSkewY       = 44;
Drill_MTG_Controller.METHOD__drill_controller_commandChange_restoreAttr    = 45;

Drill_MTG_Controller.METHOD__drill_controller_commandChange_setMove        = 51;
Drill_MTG_Controller.METHOD__drill_controller_commandChange_restoreMove    = 52;

Drill_MTG_Controller.METHOD__drill_controller_GIF_setLocked                = 61;
Drill_MTG_Controller.METHOD__drill_controller_GIF_setOncePlay              = 62;
Drill_MTG_Controller.METHOD__drill_controller_GIF_setFrame                 = 62;
...
//			返回：	> 无
//##############################
Drill_MTG_Controller.prototype.drill_controller_restoreBlendMode = function(){
...
//			返回：	> 无
//##############################
Drill_MTG_Controller.prototype.drill_controller_restoreLayerIndex = function(){
	var data = this.drill_data();
...
//			返回：	> 无
//##############################
Drill_MTG_Controller.prototype.drill_controller_restoreZIndex = function(){
	var data = this.drill_data();
...
// * A主体 - 是否 显示/隐藏（开放函数）
//==============================
Drill_MTG_Controller.prototype.drill_controller_isVisible = function(){
	if( $gameSystem._drill_MTG_enableTank[ this._drill_data_id ] === false ){ return false; }	//（如果已经创建，则设置禁用后立即不显示）
	return this._drill_visible;
}
//==============================
// * A主体 - 是否 暂停/继续（开放函数）
//==============================
Drill_MTG_Controller.prototype.drill_controller_isPause = function(){
...
Drill_MTG_Controller.prototype.drill_controller_updateDelayingCommandImportant = function(){
	...
	for(var i = 0; i < this._drill_curDelayingCommandTank.length; i++ ){
		...
		if( dc_data['left_time'] < 0 ){
			...
			if( method == Drill_MTG_Controller.METHOD__drill_controller_setPause ){
				this.drill_controller_setPause( paramList[0] );
			}else if( method == Drill_MTG_Controller.METHOD__drill_controller_periodizeCommand_setPause ){  //暂停周期指令(延迟)
				this.drill_controller_periodizeCommand_setPause( paramList[0] );
			}else if( method == Drill_MTG_Controller.METHOD__drill_controller_periodizeCommand_clear ){  //清空周期指令(延迟)
...
Drill_MTG_Controller.prototype.drill_controller_updateDelayingCommand = function(){
	...
	for(var i = 0; i < this._drill_curDelayingCommandTank.length; i++ ){
		...
		if( dc_data['left_time'] < 0 ){
			...
			switch( method ){
				case Drill_MTG_Controller.METHOD__drill_controller_setVisible:
					this.drill_controller_setVisible( paramList[0] );
					break;
				
				case Drill_MTG_Controller.METHOD__drill_controller_setBlendMode:
					this.drill_controller_setBlendMode( paramList[0] );
					break;
				case Drill_MTG_Controller.METHOD__drill_controller_setLayerIndex:
					this.drill_controller_setLayerIndex( paramList[0] );
					break;
				case Drill_MTG_Controller.METHOD__drill_controller_setZIndex:
					this.drill_controller_setZIndex( paramList[0] );
					break;
				case Drill_MTG_Controller.METHOD__drill_controller_restoreBlendMode:
					this.drill_controller_restoreBlendMode();
					break;
				case Drill_MTG_Controller.METHOD__drill_controller_restoreLayerIndex:
					this.drill_controller_restoreLayerIndex();
					break;
				case Drill_MTG_Controller.METHOD__drill_controller_restoreZIndex:
					this.drill_controller_restoreZIndex();
					break;
				
				case Drill_MTG_Controller.METHOD__drill_controller_commandChange_setOpacity:
					this.drill_controller_commandChange_setOpacity( paramList[0], paramList[1], paramList[2] );
					break;
				case Drill_MTG_Controller.METHOD__drill_controller_commandChange_setSpeedX:
					this.drill_controller_commandChange_setSpeedX( paramList[0], paramList[1], paramList[2] );
					break;
				case Drill_MTG_Controller.METHOD__drill_controller_commandChange_setSpeedY:
					this.drill_controller_commandChange_setSpeedY( paramList[0], paramList[1], paramList[2] );
					break;
				case Drill_MTG_Controller.METHOD__drill_controller_commandChange_setRotate:
					this.drill_controller_commandChange_setRotate( paramList[0], paramList[1], paramList[2] );
					break;
					
				case Drill_MTG_Controller.METHOD__drill_controller_commandChange_setScaleX:
					this.drill_controller_commandChange_setScaleX( paramList[0], paramList[1], paramList[2] );
					break;
				case Drill_MTG_Controller.METHOD__drill_controller_commandChange_setScaleY:
					this.drill_controller_commandChange_setScaleY( paramList[0], paramList[1], paramList[2] );
					break;
				case Drill_MTG_Controller.METHOD__drill_controller_commandChange_setSkewX:
					this.drill_controller_commandChange_setSkewX( paramList[0], paramList[1], paramList[2] );
					break;
				case Drill_MTG_Controller.METHOD__drill_controller_commandChange_setSkewY:
					this.drill_controller_commandChange_setSkewY( paramList[0], paramList[1], paramList[2] );
					break;
				case Drill_MTG_Controller.METHOD__drill_controller_commandChange_restoreAttr:
					this.drill_controller_commandChange_restoreAttr();
					break;
				
				case Drill_MTG_Controller.METHOD__drill_controller_commandChange_setMove:
					this.drill_controller_commandChange_setMove( paramList[0], paramList[1], paramList[2], paramList[3] );
					break;
				case Drill_MTG_Controller.METHOD__drill_controller_commandChange_restoreMove:
					this.drill_controller_commandChange_restoreMove();
					break;
				
				case Drill_MTG_Controller.METHOD__drill_controller_GIF_setLocked:
					this.drill_controller_GIF_setLocked( paramList[0] );
					break;
				case Drill_MTG_Controller.METHOD__drill_controller_GIF_setOncePlay:
					this.drill_controller_GIF_setOncePlay( paramList[0] );
					break;
				case Drill_MTG_Controller.METHOD__drill_controller_GIF_setFrame:
...
Drill_MTG_Controller.prototype.drill_controller_setDelayingCommand = function( method, paramList, delay_time ){
	...
	switch( method ){
		case Drill_MTG_Controller.METHOD__drill_controller_setVisible:
		case Drill_MTG_Controller.METHOD__drill_controller_setPause:
		case Drill_MTG_Controller.METHOD__drill_controller_periodizeCommand_setPause:
		case Drill_MTG_Controller.METHOD__drill_controller_periodizeCommand_clear:
...
// * E延迟指令 - 增加延迟（开放函数）
//==============================
Drill_MTG_Controller.prototype.drill_controller_addDelayingTime = function( time ){
...
//==============================
Drill_MTG_Controller.prototype.drill_controller_periodizeCommand_getWaitAndClearTime = function(){
...
//==============================
Drill_MTG_Controller.prototype.drill_controller_periodizeCommand_setPause = function( enabled ){
...
//==============================
Drill_MTG_Controller.prototype.drill_controller_periodizeCommand_waitAndPause = function(){
...
//==============================
Drill_MTG_Controller.prototype.drill_controller_periodizeCommand_clear = function(){
	this._drill_curPeriodizeCommandTank = [];
...
//==============================
Drill_MTG_Controller.prototype.drill_controller_periodizeCommand_waitAndClear = function(){
