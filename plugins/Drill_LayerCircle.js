...
//##############################
Scene_Map.prototype.drill_LCi_layerMoveingReference = function( x, y, reference, option ){
	return this.drill_LCi_layerMoveingReference_Private( x, y, reference, option );
}
//##############################
// * 地图层级 - 图片层级排序【标准函数】
//				
