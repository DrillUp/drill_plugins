 ...
 * 测试结果：   战斗界面中，平均消耗为：【10.34ms】
 *              200个事件的地图中，平均消耗为：【13.89ms】
 *              100个事件的地图中，平均消耗为：【10.41ms】
...
//		★性能测试消耗	2025/4/30：
//							》没创建图片时，就没有消耗。
//							》4.2ms（drill_PFOE_updateEffect）1.6ms（drill_PCE_updateBitmap）
//		★最坏情况		暂无
...
//=============================================================================
	...
	// * 提示信息 - 报错 - NaN校验值
	//==============================
	DrillUp.drill_PCE_getPluginTip_ParamIsNaN = function( param_name, check_tank ){
		var text = "【" + DrillUp.g_PCE_PluginTip_curName + "】\n检测到参数"+param_name+"出现了NaN值，请及时检查你的函数。";
		if( check_tank ){
