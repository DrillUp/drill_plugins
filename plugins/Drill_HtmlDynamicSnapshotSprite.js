...
/*:
 * @plugindesc [v1.3]        游戏窗体 - 天窗层的多层动态快照
 * @author Drill_up
 * 
 ...
 * 插件指令：>天窗层动态快照 : 批量动态快照[4,5] : 修改中心锚点 : 锚点[0.5,0.5]
 * 插件指令：>天窗层动态快照 : 批量动态快照变量[21,22] : 修改中心锚点 : 锚点[0.5,0.5]
 * 插件指令：>天窗层动态快照 : 全部动态快照 : 修改中心锚点 : 锚点[0.5,0.5]
 * 
 ...
 * 
 * 插件指令：>天窗层动态快照 : 动态快照[11] : 添加周期-隐藏(周期) : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>天窗层动态快照 : 动态快照变量[21] : 添加周期-隐藏(周期) : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>天窗层动态快照 : 批量动态快照[7,8] : 添加周期-隐藏(周期) : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>天窗层动态快照 : 批量动态快照变量[21,22] : 添加周期-隐藏(周期) : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>天窗层动态快照 : 全部动态快照 : 添加周期-隐藏(周期) : 周期时长[90] : 周期内开始时间[0]
 * 
 * 插件指令：>天窗层动态快照 : 动态快照[11] : 添加周期-显示(周期) : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>天窗层动态快照 : 动态快照[11] : 添加周期-隐藏(周期) : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>天窗层动态快照 : 动态快照[11] : 添加周期-暂停(周期) : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>天窗层动态快照 : 动态快照[11] : 添加周期-继续(周期) : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>天窗层动态快照 : 动态快照[11] : 添加周期-修改单属性(周期) : 透明度[255] : 时间[60] : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>天窗层动态快照 : 动态快照[11] : 添加周期-修改单属性(周期) : 透明度变量[21] : 时间[60] : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>天窗层动态快照 : 动态快照[11] : 添加周期-修改单属性(周期) : 旋转[90] : 时间[60] : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>天窗层动态快照 : 动态快照[11] : 添加周期-修改单属性(周期) : 旋转变量[21] : 时间[60] : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>天窗层动态快照 : 动态快照[11] : 添加周期-修改单属性(周期) : 转速[10.0] : 时间[60] : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>天窗层动态快照 : 动态快照[11] : 添加周期-修改单属性(周期) : 转速变量[21] : 时间[60] : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>天窗层动态快照 : 动态快照[11] : 添加周期-修改单属性(周期) : 缩放X[1.2] : 时间[60] : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>天窗层动态快照 : 动态快照[11] : 添加周期-修改单属性(周期) : 缩放X变量%[21] : 时间[60] : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>天窗层动态快照 : 动态快照[11] : 添加周期-修改单属性(周期) : 缩放Y[1.2] : 时间[60] : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>天窗层动态快照 : 动态快照[11] : 添加周期-修改单属性(周期) : 缩放Y变量%[21] : 时间[60] : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>天窗层动态快照 : 动态快照[11] : 添加周期-修改单属性(周期) : 斜切X[0.2] : 时间[60] : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>天窗层动态快照 : 动态快照[11] : 添加周期-修改单属性(周期) : 斜切X变量%[21] : 时间[60] : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>天窗层动态快照 : 动态快照[11] : 添加周期-修改单属性(周期) : 斜切Y[0.2] : 时间[60] : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>天窗层动态快照 : 动态快照[11] : 添加周期-修改单属性(周期) : 斜切Y变量%[21] : 时间[60] : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>天窗层动态快照 : 动态快照[11] : 添加周期-还原所有单属性(周期) : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>天窗层动态快照 : 动态快照[11] : 清空周期指令
 * 
 * 1.前半部分（动态快照[11]）和 后半部分（ 添加周期-隐藏(周期) ）
 *   的参数可以随意组合。一共有5*20种组合方式。
 ...
 * 
 * 插件指令：>天窗层动态快照 : 动态快照[11] : 添加周期-移动到(周期)-匀速移动 : 位置[100,100] : 时间[60] : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>天窗层动态快照 : 动态快照[11] : 添加周期-移动到(周期)-匀速移动 : 位置变量[25,26] : 时间[60] : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>天窗层动态快照 : 动态快照[11] : 添加周期-移动到(周期)-弹性移动 : 位置[100,100] : 时间[60] : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>天窗层动态快照 : 动态快照[11] : 添加周期-移动到(周期)-弹性移动 : 位置变量[25,26] : 时间[60] : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>天窗层动态快照 : 动态快照[11] : 添加周期-移动到(周期)-增减速移动 : 位置[100,100] : 时间[60] : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>天窗层动态快照 : 动态快照[11] : 添加周期-移动到(周期)-增减速移动 : 位置变量[25,26] : 时间[60] : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>天窗层动态快照 : 动态快照[11] : 添加周期-移动到(周期)-执行归位 : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>天窗层动态快照 : 动态快照[11] : 清空周期指令
 * 
 * 1.前半部分（动态快照[11]）和 后半部分（ 添加周期-移动到(周期)-匀速移动 ）
 ...
 * 测试结果1：  200个事件的地图中，平均消耗为：【44.06ms】
 *              100个事件的地图中，平均消耗为：【32.50ms】
 *               50个事件的地图中，平均消耗为：【27.62ms】
 * 测试方法2：  在不同的界面中，进行性能测试。
 * 测试结果2：  战斗界面中，平均消耗为：【31.43ms】
 *              菜单界面中，平均消耗为：【28.64ms】
 *
 * 1.插件只在自己作用域下工作消耗性能，在其它作用域下是不工作的。
 *   测试结果并不是精确值，范围在给定值的10ms范围内波动。
 *   更多性能介绍，去看看 "0.性能测试报告 > 关于插件性能.docx"。
 * 2.动态快照复制了游戏画面，所以消耗可能会多一些。
 * 
 * -----------------------------------------------------------------------------
 * ----更新日志
 * [v1.0]
...
//		★性能测试因素	特效管理层
//		★性能测试消耗	2026/2/11：
//							》32.5ms（Drill_HDSS_Sprite.update）16.0ms（drill_HDSS_updateController）
//		★最坏情况		暂无
//		★备注			动态快照的帧刷新函数，渲染器的处理在核心插件，这里可能捕获不到。
//		
//		★优化记录		暂无
//
//<<<<<<<<插件记录<<<<<<<<
...
//=============================================================================
	...
	// * 提示信息 - 报错 - 找不到样式
	//==============================
	DrillUp.drill_HDSS_getPluginTip_StyleNotFind = function( style_id ){
		return "【" + DrillUp.g_HDSS_PluginTip_curName + "】\n对象创建失败，id为"+style_id+"的样式配置为空或不存在。";
	};
	//==============================
	// * 提示信息 - 报错 - NaN校验值
	//==============================
	DrillUp.drill_HDSS_getPluginTip_ParamIsNaN = function( param_name, check_tank ){
		var text = "【" + DrillUp.g_HDSS_PluginTip_curName + "】\n检测到参数"+param_name+"出现了NaN值，请及时检查你的函数。";
		if( check_tank ){
...
//=============================================================================
	...
	//				（~struct~HDSSSpriteData）
	//==============================
	DrillUp.drill_HDSS_spriteDataInit = function( dataFrom ){
		var data = {};
		...
		Drill_HDSS_Controller.drill_controller_initData( data );
	...
	// * 静态数据 - 最后继承1级
	//==============================
	var _drill_HDSS_scene_initialize = SceneManager.initialize;
	SceneManager.initialize = function() {
		_drill_HDSS_scene_initialize.call(this);
		
		/*-----------------动态快照------------------*/
		for( var i = 0; i < DrillUp.g_HDSS_layers.length; i++ ){
			var temp = DrillUp.g_HDSS_layers[i];
			if( temp != undefined ){
				DrillUp.g_HDSS_layers[i] = DrillUp.drill_HDSS_spriteDataInit( temp );
			}
		}
	}
	/*-----------------动态快照------------------*/
	...
	for (var i = 0; i < DrillUp.g_HDSS_layers_length; i++) {
		if( DrillUp.parameters["动态快照层-" + String(i+1) ] != undefined &&
			...
			DrillUp.g_HDSS_layers[i] = JSON.parse(DrillUp.parameters["动态快照层-" + String(i+1) ]);
		}else{
			DrillUp.g_HDSS_layers[i] = undefined;		//（设为空值，节约静态数据占用容量）
		}
	}
...
Game_Interpreter.prototype.pluginCommand = function( command, args ){
	...
	this.drill_HDSS_pluginCommand( command, args );
}
//==============================
// * 插件指令 - 指令执行
//==============================
Game_Interpreter.prototype.drill_HDSS_pluginCommand = function( command, args ){
...
// * 控制器与贴图 - 函数复制
//==============================
Scene_Battle.prototype.drill_HDSS_create = Scene_Map.prototype.drill_HDSS_create;						//界面创建       『多场景与游戏窗体-战斗界面』
Scene_Battle.prototype.drill_HDSS_updateController = Scene_Map.prototype.drill_HDSS_updateController;	//帧刷新 控制器  『多场景与游戏窗体-战斗界面』
Scene_Battle.prototype.drill_HDSS_updateAttr = Scene_Map.prototype.drill_HDSS_updateAttr;				//帧刷新 基础特性『多场景与游戏窗体-战斗界面』
Scene_Battle.prototype.drill_HDSS_updateDestroy = Scene_Map.prototype.drill_HDSS_updateDestroy;			//帧刷新 销毁    『多场景与游戏窗体-战斗界面』
...
// * 控制器与贴图 - 函数复制
//==============================
Scene_MenuBase.prototype.drill_HDSS_create = Scene_Map.prototype.drill_HDSS_create;						//界面创建       『多场景与游戏窗体-菜单界面』
Scene_MenuBase.prototype.drill_HDSS_updateController = Scene_Map.prototype.drill_HDSS_updateController;	//帧刷新 控制器  『多场景与游戏窗体-菜单界面』
Scene_MenuBase.prototype.drill_HDSS_updateAttr = Scene_Map.prototype.drill_HDSS_updateAttr;				//帧刷新 基础特性『多场景与游戏窗体-菜单界面』
Scene_MenuBase.prototype.drill_HDSS_updateDestroy = Scene_Map.prototype.drill_HDSS_updateDestroy;		//帧刷新 销毁    『多场景与游戏窗体-菜单界面』
...
//##############################
Drill_HDSS_Controller.drill_controller_initData = function( data ){
...
//##############################
DrillUp.g_HDSS_notFindStyleAlertOnce = true;
//##############################
...
Drill_HDSS_Controller.prototype.drill_data = function(){
	...
	var cur_styleData = DrillUp.g_HDSS_layers[ this._drill_data_id ];
	if( cur_styleData == undefined ){
		
		// > 『控制器与贴图的样式-静态数据』 - 校验+提示信息（只执行一次）
		if( DrillUp.g_HDSS_notFindStyleAlertOnce == true ){
			DrillUp.g_HDSS_notFindStyleAlertOnce = false;
			alert( DrillUp.drill_HDSS_getPluginTip_StyleNotFind(cur_styleId) );
		}
		return Drill_HDSS_Controller.emptyData;
	}
...
// * C校验值 - 初始化子功能
//==============================
Drill_HDSS_Controller.prototype.drill_controller_initCheck = function(){
	//（无）
}
//==============================
// * C校验值 - 校验标记
...
Drill_HDSS_Controller.prototype.drill_controller_updateCheckNaN = function(){
	...
	if( DrillUp.g_HDSS_checkNaN == true ){
		if( isNaN( this.drill_controller_finalTransform_x() ) ){
			...
			alert( DrillUp.drill_HDSS_getPluginTip_ParamIsNaN( "drill_controller_finalTransform_x", check_tank ) );
		}
		if( isNaN( this.drill_controller_finalTransform_y() ) ){
			DrillUp.g_HDSS_checkNaN = false;
			var check_tank = {};
			check_tank["_drill_change_y"] = this._drill_change_y;
			alert( DrillUp.drill_HDSS_getPluginTip_ParamIsNaN( "drill_controller_finalTransform_y", check_tank ) );
		}
...
// * F周期指令 - 初始化子功能
//==============================
Drill_HDSS_Controller.prototype.drill_controller_initPeriodizeCommand = function(){
...
//			说明：	> 此处的时间流逝不会因为 暂停 而停止流逝。
//==============================
Drill_HDSS_Controller.prototype.drill_controller_updatePeriodizeCommandImportant = function(){
...
// * F周期指令 - 帧刷新 - 执行周期指令
//==============================
Drill_HDSS_Controller.prototype.drill_controller_updatePeriodizeCommand = function(){
	if( this._drill_curPeriodizeCommandTank.length == 0 ){ return; }
...
// * F周期指令 - 设置指令（开放函数）
//==============================
Drill_HDSS_Controller.prototype.drill_controller_setPeriodizeCommand = function( method, paramList, time_period, time_start ){
	if( method != "drill_controller_setVisible" &&
		method != "drill_controller_setPause" &&
...
// * F周期指令 - 清空全部（开放函数）
//==============================
Drill_HDSS_Controller.prototype.drill_controller_clearPeriodizeCommand = function(){
	this._drill_curPeriodizeCommandTank = [];
}
...
// * F周期指令 - 初始化子功能
//==============================
Drill_HDSS_Sprite.prototype.drill_sprite_initPeriodizeCommand = function(){
	//（无）
}
