 ...
 * 1.插件的作用域：战斗界面、地图界面。
 *   作用于对话框。
 * 2.了解更多窗口字符，可以去看看 "23.窗口字符 > 关于对话文字速度.docx"。
 * 细节：
 *   (1.插件本质上只修改 每个字的间隔时长。
...
// * 存储数据 - 初始化
//==============================
var _drill_DMS_system_initialize = Game_System.prototype.initialize;
Game_System.prototype.initialize = function() {
    _drill_DMS_system_initialize.call(this);
