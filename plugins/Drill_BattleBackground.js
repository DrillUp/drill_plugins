 ...
 * 
 * 插件指令：>战斗背景 : 背景[11] : 添加周期-隐藏(周期) : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>战斗背景 : 背景变量[21] : 添加周期-隐藏(周期) : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>战斗背景 : 批量背景[7,8] : 添加周期-隐藏(周期) : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>战斗背景 : 批量背景变量[21,22] : 添加周期-隐藏(周期) : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>战斗背景 : 全部背景 : 添加周期-隐藏(周期) : 周期时长[90] : 周期内开始时间[0]
 * 
 * 插件指令：>战斗背景 : 背景[11] : 添加周期-显示(周期) : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>战斗背景 : 背景[11] : 添加周期-隐藏(周期) : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>战斗背景 : 背景[11] : 添加周期-暂停(周期) : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>战斗背景 : 背景[11] : 添加周期-继续(周期) : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>战斗背景 : 背景[11] : 添加周期-修改单属性(周期) : 透明度[255] : 时间[60] : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>战斗背景 : 背景[11] : 添加周期-修改单属性(周期) : 透明度变量[21] : 时间[60] : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>战斗背景 : 背景[11] : 添加周期-修改单属性(周期) : 旋转[90] : 时间[60] : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>战斗背景 : 背景[11] : 添加周期-修改单属性(周期) : 旋转变量[21] : 时间[60] : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>战斗背景 : 背景[11] : 添加周期-修改单属性(周期) : 移动速度X[1.5] : 时间[60] : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>战斗背景 : 背景[11] : 添加周期-修改单属性(周期) : 移动速度X变量%[21] : 时间[60] : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>战斗背景 : 背景[11] : 添加周期-修改单属性(周期) : 移动速度Y[1.5] : 时间[60] : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>战斗背景 : 背景[11] : 添加周期-修改单属性(周期) : 移动速度Y变量%[21] : 时间[60] : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>战斗背景 : 背景[11] : 添加周期-修改单属性(周期) : 缩放X[1.2] : 时间[60] : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>战斗背景 : 背景[11] : 添加周期-修改单属性(周期) : 缩放X变量%[21] : 时间[60] : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>战斗背景 : 背景[11] : 添加周期-修改单属性(周期) : 缩放Y[1.2] : 时间[60] : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>战斗背景 : 背景[11] : 添加周期-修改单属性(周期) : 缩放Y变量%[21] : 时间[60] : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>战斗背景 : 背景[11] : 添加周期-修改单属性(周期) : 斜切X[0.2] : 时间[60] : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>战斗背景 : 背景[11] : 添加周期-修改单属性(周期) : 斜切X变量%[21] : 时间[60] : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>战斗背景 : 背景[11] : 添加周期-修改单属性(周期) : 斜切Y[0.2] : 时间[60] : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>战斗背景 : 背景[11] : 添加周期-修改单属性(周期) : 斜切Y变量%[21] : 时间[60] : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>战斗背景 : 背景[11] : 添加周期-还原所有单属性(周期) : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>战斗背景 : 背景[11] : 清空周期指令
 * 
 ...
 * 
 * 插件指令：>战斗背景 : 背景[11] : 添加周期-移动到(周期)-匀速移动 : 位置[100,100] : 时间[60] : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>战斗背景 : 背景[11] : 添加周期-移动到(周期)-匀速移动 : 位置变量[25,26] : 时间[60] : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>战斗背景 : 背景[11] : 添加周期-移动到(周期)-弹性移动 : 位置[100,100] : 时间[60] : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>战斗背景 : 背景[11] : 添加周期-移动到(周期)-弹性移动 : 位置变量[25,26] : 时间[60] : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>战斗背景 : 背景[11] : 添加周期-移动到(周期)-增减速移动 : 位置[100,100] : 时间[60] : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>战斗背景 : 背景[11] : 添加周期-移动到(周期)-增减速移动 : 位置变量[25,26] : 时间[60] : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>战斗背景 : 背景[11] : 添加周期-移动到(周期)-执行归位 : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>战斗背景 : 背景[11] : 清空周期指令
 * 
...
//=============================================================================
	...
	// * 提示信息 - 报错 - 找不到样式
	//==============================
	DrillUp.drill_BBa_getPluginTip_StyleNotFind = function( style_id ){
		return "【" + DrillUp.g_BBa_PluginTip_curName + "】\n对象创建失败，id为"+style_id+"的样式配置为空或不存在。";
	};
	//==============================
	// * 提示信息 - 报错 - NaN校验值
	//==============================
	DrillUp.drill_BBa_getPluginTip_ParamIsNaN = function( param_name, check_tank ){
		var text = "【" + DrillUp.g_BBa_PluginTip_curName + "】\n检测到参数"+param_name+"出现了NaN值，请及时检查你的函数。";
		if( check_tank ){
...
//=============================================================================
	...
	DrillUp.drill_BBa_backgroundInit = function( dataFrom ){
		...
		Drill_BBa_Controller.drill_controller_initData( data );
	...
	// * 静态数据 - 最后继承1级
	//==============================
	var _drill_BBa_scene_initialize = SceneManager.initialize;
	SceneManager.initialize = function() {
		_drill_BBa_scene_initialize.call(this);
		
		/*-----------------背景------------------*/
		for( var i = 0; i < DrillUp.g_BBa_style.length; i++ ){
			var temp = DrillUp.g_BBa_style[i];
			if( temp != undefined ){
	...
	for( var i = 0; i < DrillUp.g_BBa_style_length; i++ ){
		if( DrillUp.parameters["背景样式-" + String(i+1) ] != undefined &&
			...
			DrillUp.g_BBa_style[i] = JSON.parse(DrillUp.parameters["背景样式-" + String(i+1) ]);
		}else{
			DrillUp.g_BBa_style[i] = undefined;		//（设为空值，节约静态数据占用容量）
		}
	}
...
Game_Interpreter.prototype.pluginCommand = function( command, args ){
	...
	this.drill_BBa_pluginCommand( command, args );
}
//==============================
// * 插件指令 - 指令执行
//==============================
Game_Interpreter.prototype.drill_BBa_pluginCommand = function( command, args ){
...
//##############################
Drill_BBa_Controller.drill_controller_initData = function( data ){
...
//##############################
DrillUp.g_BBa_notFindStyleAlertOnce = true;
//##############################
...
Drill_BBa_Controller.prototype.drill_data = function(){
	...
	var cur_styleData = DrillUp.g_BBa_style[ this._drill_data_id ];
	if( cur_styleData == undefined ){
		
		// > 『控制器与贴图的样式-静态数据』 - 校验+提示信息（只执行一次）
		if( DrillUp.g_BBa_notFindStyleAlertOnce == true ){
			DrillUp.g_BBa_notFindStyleAlertOnce = false;
			alert( DrillUp.drill_BBa_getPluginTip_StyleNotFind(cur_styleId) );
		}
		return Drill_BBa_Controller.emptyData;
	}
...
// * C校验值 - 初始化子功能
//==============================
Drill_BBa_Controller.prototype.drill_controller_initCheck = function(){
	//（无）
}
//==============================
// * C校验值 - 校验标记
...
Drill_BBa_Controller.prototype.drill_controller_updateCheckNaN = function(){
	...
	if( DrillUp.g_BBa_checkNaN == true ){
		if( isNaN( this.drill_controller_finalTransform_x() ) ){
			...
			alert( DrillUp.drill_BBa_getPluginTip_ParamIsNaN( "drill_controller_finalTransform_x", check_tank ) );
		}
		if( isNaN( this.drill_controller_finalTransform_y() ) ){
			...
			alert( DrillUp.drill_BBa_getPluginTip_ParamIsNaN( "drill_controller_finalTransform_y", check_tank ) );
		}
...
// * F周期指令 - 初始化子功能
//==============================
Drill_BBa_Controller.prototype.drill_controller_initPeriodizeCommand = function(){
...
//			说明：	> 此处的时间流逝不会因为 暂停 而停止流逝。
//==============================
Drill_BBa_Controller.prototype.drill_controller_updatePeriodizeCommandImportant = function(){
...
// * F周期指令 - 帧刷新 - 执行周期指令
//==============================
Drill_BBa_Controller.prototype.drill_controller_updatePeriodizeCommand = function(){
	if( this._drill_curPeriodizeCommandTank.length == 0 ){ return; }
...
// * F周期指令 - 设置指令（开放函数）
//==============================
Drill_BBa_Controller.prototype.drill_controller_setPeriodizeCommand = function( method, paramList, time_period, time_start ){
	if( method != "drill_controller_setVisible" &&
		method != "drill_controller_setPause" &&
...
// * F周期指令 - 清空全部（开放函数）
//==============================
Drill_BBa_Controller.prototype.drill_controller_clearPeriodizeCommand = function(){
	this._drill_curPeriodizeCommandTank = [];
}
...
// * F周期指令 - 初始化子功能
//==============================
Drill_BBa_Sprite.prototype.drill_sprite_initPeriodizeCommand = function(){
	//（无）
}
