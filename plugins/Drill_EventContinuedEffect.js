...
Game_Character.prototype.drill_ECE_updateSustainingShakeRotate = function() {
	...
	// > 锚点(0.5,1.0)锁定
	var fix_point = $gameTemp.drill_ECE_getFixPointInAnchor( ef.anchor_x,ef.anchor_y, 0.5,1.0, ef.real_width,ef.real_height, ef.rotation, ef.scale_x, ef.scale_y );
	ef.x = fix_point.x;	
	ef.y = fix_point.y;	
...
Game_Character.prototype.drill_ECE_updateSustainingPendulumRotate = function() {
	...
	// > 锚点(0.5,1.0)锁定
	var fix_point = $gameTemp.drill_ECE_getFixPointInAnchor( ef.anchor_x,ef.anchor_y, 0.5,0.0, ef.real_width,ef.real_height, ef.rotation, ef.scale_x, ef.scale_y );
	ef.x = fix_point.x;	
	ef.y = fix_point.y;	
