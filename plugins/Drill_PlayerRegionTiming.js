...
// * 存储数据 - 初始化
//==============================
var _drill_PRT_system_initialize = Game_System.prototype.initialize;
Game_System.prototype.initialize = function() {
    _drill_PRT_system_initialize.call(this);
...
// * 管理器 - 读取数据
//==============================
var _drill_PRT_extractSaveContents = DataManager.extractSaveContents;
DataManager.extractSaveContents = function( contents ){
	_drill_PRT_extractSaveContents.call( this, contents );
	$gameSystem.drill_PRT_checkData();
}
//==============================
// * 管理器 - 检查数据
//==============================
Game_System.prototype.drill_PRT_checkData = function() {
