...
// ** 存储变量初始化
//=============================================================================
var _drill_DCCE_sys_initialize = Game_System.prototype.initialize;
Game_System.prototype.initialize = function() {
    _drill_DCCE_sys_initialize.call(this);
...
Drill_DCCE_Sprite.prototype.drill_DCCE_updateSustainingRotate = function() {
	...
	// > 锚点(0.5,0.5)锁定
	var fix_point = $gameTemp.drill_DCCE_getFixPointInAnchor( ef.anchor_x,ef.anchor_y, 0.5,0.5, ef.real_width,ef.real_height, ef.rotation, ef.scale_x, ef.scale_y );
	ef.x = fix_point.x;	
	ef.y = fix_point.y;	
...
Drill_DCCE_Sprite.prototype.drill_DCCE_updateSustainingShakeRotate = function() {
	...
	// > 锚点(0.5,1.0)锁定
	var fix_point = $gameTemp.drill_DCCE_getFixPointInAnchor( ef.anchor_x,ef.anchor_y, 0.5,1.0, ef.real_width,ef.real_height, ef.rotation, ef.scale_x, ef.scale_y );
	ef.x = fix_point.x;	
	ef.y = fix_point.y;	
...
Drill_DCCE_Sprite.prototype.drill_DCCE_updateSustainingPendulumRotate = function() {
	...
	// > 锚点(0.5,0.0)锁定
	var fix_point = $gameTemp.drill_DCCE_getFixPointInAnchor( ef.anchor_x,ef.anchor_y, 0.5,0.0, ef.real_width,ef.real_height, ef.rotation, ef.scale_x, ef.scale_y );
	ef.x = fix_point.x;	
	ef.y = fix_point.y;	
