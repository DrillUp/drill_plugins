 ...
 *   (1.此漏洞来源于 YEP核心插件 。
 *      文档也有说明，可见："0.问题解答集合（FAQ） > Rmmv中的罕见问题.docx"
 *   (2.目前已知 危害到了镜头插件、对话框插件。
 *      但用这些插件时，不会出现抖动。
 *   (3.影响：以镜头插件为例，玩家总会发现一些事件会随着镜头移动而抖动。
 *   (4.解决方案：更新示例中的YEP_CoreEngine插件，
 *      或者打开YEP_CoreEngine插件，删除函数Yanfly.Core.Sprite_updateTransform。
 * 
 * -----------------------------------------------------------------------------
 * ----可选设定 - 插件指令
 * 你可以通过插件指令手动控制开关：
