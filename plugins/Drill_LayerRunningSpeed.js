 ...
 * =============================================================================
 * 地图界面中rmmv默认自带长按加速，你可以对该功能进行控制修改。
 * 
 * -----------------------------------------------------------------------------
 * ----设定注意事项
 * 1.插件的作用域：地图界面
 ...
 * 2.注意，该插件虽然只轻微改改配置，但是修改的影响类似于变速齿轮。
 *   如果开了五倍速，整体消耗可能会乘以五倍。
 * 
 * -----------------------------------------------------------------------------
 * ----更新日志
...
// * 存储数据初始化
//=============================================================================
var _drill_LRS_system_initialize = Game_System.prototype.initialize;
Game_System.prototype.initialize = function() {
    _drill_LRS_system_initialize.call(this);
