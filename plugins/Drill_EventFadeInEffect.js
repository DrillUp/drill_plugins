 ...
 *   (2.开启"透明度检查"后，如果事件的透明度为255，则动作会被阻止播放。
 * 设计：
 ...
 * 你需要通过下面插件指令来执行显现动作：
 * 
 * 插件指令：>显现动作 : 玩家 : 标准弹跳 : 总时间[60] : 高度[168]
 * 插件指令：>显现动作 : 玩家领队 : 标准弹跳 : 总时间[60] : 高度[168]
 * 插件指令：>显现动作 : 玩家全员 : 标准弹跳 : 总时间[60] : 高度[168]
 * 插件指令：>显现动作 : 玩家队员[1] : 标准弹跳 : 总时间[60] : 高度[168]
 * 插件指令：>显现动作 : 玩家队员变量[21] : 标准弹跳 : 总时间[60] : 高度[168]
 * 插件指令：>显现动作 : 本事件 : 标准弹跳 : 总时间[60] : 高度[168]
 * 插件指令：>显现动作 : 事件[1] : 标准弹跳 : 总时间[60] : 高度[168]
 * 插件指令：>显现动作 : 事件变量[1] : 标准弹跳 : 总时间[60] : 高度[168]
 * 插件指令：>显现动作 : 批量事件[10,11] : 标准弹跳 : 总时间[60] : 高度[168]
 * 插件指令：>显现动作 : 批量事件变量[21,22] : 标准弹跳 : 总时间[60] : 高度[168]
 * 
 * 插件指令：>显现动作 : 本事件 : 直接显现 : 总时间[60]
 * 插件指令：>显现动作 : 本事件 : 移动显现 : 总时间[60] : 方向角度[90] : 移动距离[100]
 * 插件指令：>显现动作 : 本事件 : 标准落下 : 总时间[60] : 缓冲时间[20] : 高度[168]
 * 插件指令：>显现动作 : 本事件 : 标准弹跳 : 总时间[60] : 高度[100]
 * 插件指令：>显现动作 : 本事件 : 横向冒出 : 总时间[60] : 横向比例[1.5]
 * 插件指令：>显现动作 : 本事件 : 横向冒出(不透明) : 总时间[60] : 横向比例[1.5]
 * 插件指令：>显现动作 : 本事件 : 纵向冒出 : 总时间[60] : 纵向比例[1.5]
 * 插件指令：>显现动作 : 本事件 : 纵向冒出(不透明) : 总时间[60] : 纵向比例[1.5]
 * 插件指令：>显现动作 : 本事件 : 放大出现 : 总时间[60] : 缓冲时间[20]
 * 插件指令：>显现动作 : 本事件 : 放大出现(不透明) : 总时间[60] : 缓冲时间[20]
 * 插件指令：>显现动作 : 本事件 : 弹性放大出现 : 总时间[60] : 比例溢出[0.2] : 中心锚点[0.5,1.0]
 * 插件指令：>显现动作 : 本事件 : 弹性放大出现(不透明) : 总时间[60] : 比例溢出[0.2] : 中心锚点[0.5,1.0]
 * 插件指令：>显现动作 : 本事件 : 顺时针螺旋显现 : 总时间[120] : 最大螺旋半径[108] : 螺旋一圈时间[40] : 透明度变化时间[30]
 * 插件指令：>显现动作 : 本事件 : 逆时针螺旋显现 : 总时间[120] : 最大螺旋半径[108] : 螺旋一圈时间[40] : 透明度变化时间[30]
 * 插件指令：>显现动作 : 本事件 : 立即终止动作
 * 
 * 1.前半部分（玩家）和 后半部分（标准落下 : 总时间[60] : 缓冲时间[20] : 高度[168]）
 ...
 * 测试结果：   200个事件的地图中，平均消耗为：【14.50ms】
 *              100个事件的地图中，平均消耗为：【11.90ms】
 *               50个事件的地图中，平均消耗为：【8.16ms】
 *
...
//		★性能测试因素	动作效果管理层
//		★性能测试消耗	2025/4/30：
//							》14.5ms（drill_EFIE_updateBitmap）11.9ms（drill_EFIE_updateEffect）
//		★最坏情况		所有事件都在执行动作。
...
//=============================================================================
	...
	// * 提示信息 - 报错 - 时间计算不正确
	//==============================
	DrillUp.drill_EFIE_getPluginTip_allTimeError = function( playing_type ){
		return "【" + DrillUp.g_EFIE_PluginTip_curName + "】\n动作效果\""+playing_type+"\"播放失败，其配置的时间参数总和大于 总时间的值。";
	};
	//==============================
	// * 提示信息 - 报错 - NaN校验值
	//==============================
	DrillUp.drill_EFIE_getPluginTip_ParamIsNaN = function( param_name, check_tank ){
		var text = "【" + DrillUp.g_EFIE_PluginTip_curName + "】\n检测到参数"+param_name+"出现了NaN值，请及时检查你的函数。";
		if( check_tank ){
...
Game_Interpreter.prototype.pluginCommand = function( command, args ){
	...
	this.drill_EFIE_pluginCommand( command, args );
}
//==============================
// * 插件指令 - 指令执行
//==============================
Game_Interpreter.prototype.drill_EFIE_pluginCommand = function( command, args ){
	if( command === ">显现动作" ){
		...
		if( args.length == 6 ){
			...
			if( type == "获取正在播放的类型" && Imported.Drill_CoreOfString ){	//【系统 - 字符串核心】
				...
				if( e_chars != null){
					var str = false;
					for( var k=0; k < e_chars.length; k++ ){
						str = e_chars[k].drill_EFIE_getPlayingType();
					}
				...
				if( p_chars != null){
					var str = false;
					for( var k=0; k < p_chars.length; k++ ){
						str = p_chars[k].drill_EFIE_getPlayingType();
					}
					$gameStrings.setValue( temp1, str );
				}
			}
		...
		if( args.length == 12 ){
			...
			if( type == "顺时针螺旋显现" ){
				...
				if( e_chars != null ){
					for( var k=0; k < e_chars.length; k++ ){
						e_chars[k].drill_EFIE_playShowingSpiralMove( Number(temp1), 1, Number(temp2),Number(temp3),Number(temp4) );
					}
				}
				if( p_chars != null ){
					for( var k=0; k < p_chars.length; k++ ){
						p_chars[k].drill_EFIE_playShowingSpiralMove( Number(temp1), 1, Number(temp2),Number(temp3),Number(temp4) );
					}
				}
			}
			/*-----------------逆时针螺旋显现------------------*/
...
Sprite_Character.prototype.update = function() {
	...
	if( this._character != undefined ){
		this.drill_EFIE_updateEffect();			//帧刷新 - 执行变换
		this.drill_EFIE_updateBitmap();			//帧刷新 - 获取资源宽高
	}
};
//==============================
// * 物体贴图控制 - 帧刷新 - 执行变换
...
Sprite_Character.prototype.drill_EFIE_updateEffect = function() {
	if( this._character.drill_EFIE_isPlaying() != true ){ return; }
		
	var sprite_data = this._character._drill_EFIE_spriteData;
												// 贴图 - 锚点X（不操作）
												// 贴图 - 锚点Y（不操作）
...
Sprite_Character.prototype.drill_EFIE_updateBitmap = function() {
	if( this.bitmap && this.bitmap.isReady() &&
		this._character._drill_EFIE_spriteData != undefined ){
		this._character._drill_EFIE_spriteData.real_width = this.patternWidth();
		this._character._drill_EFIE_spriteData.real_height = this.patternHeight();
	}
}
...
Game_Character.prototype.initialize = function() {
	this._drill_EFIE_spriteData = undefined;
	this._drill_EFIE_param = undefined;
...
//==============================
Game_Character.prototype.drill_EFIE_checkData = function() {
	
	// > 贴图属性
	if( this._drill_EFIE_spriteData == undefined ){
		this._drill_EFIE_spriteData = {};				//（不要用initMembers，follower没有这个方法）
		this._drill_EFIE_spriteData.anchor_x = 0.5;		// 锚点X
		this._drill_EFIE_spriteData.anchor_y = 1.0;		// 锚点Y
		this._drill_EFIE_spriteData.x = 0;				// 位置X
		this._drill_EFIE_spriteData.y = 0;				// 位置Y
		this._drill_EFIE_spriteData.scale_x = 0;		// 缩放X
		this._drill_EFIE_spriteData.scale_y = 0;		// 缩放Y
		this._drill_EFIE_spriteData.opacity = 0;		// 透明度（不叠加）
		this._drill_EFIE_spriteData.skew_x = 0;			// 斜切X
		this._drill_EFIE_spriteData.skew_y = 0;			// 斜切Y
		this._drill_EFIE_spriteData.rotation = 0;		// 旋转
		
		this._drill_EFIE_spriteData.real_width = -1;	// 贴图宽
		this._drill_EFIE_spriteData.real_height = -1;	// 贴图高
	}
	
	// > 动作配置
	if( this._drill_EFIE_param == undefined ){
		this._drill_EFIE_param = {};
		this._drill_EFIE_param.playing_type = "";		// 显示类型
	}
}
//==============================
// * 物体的属性 - 帧刷新
...
Game_CharacterBase.prototype.update = function() {
	...
	if( this._drill_EFIE_spriteData == undefined ){ return; } 		//需要等资源加载完成
	if( this._drill_EFIE_spriteData.real_width == -1 ){ return; }	//
	if( this._drill_EFIE_spriteData.real_height == -1 ){ return; }	//
	...
	this.drill_EFIE_updateShowingSpiralMove();		//帧刷新 - 顺时针/逆时针螺旋显现
}
...
Game_Character.prototype.drill_EFIE_isPlaying = function() {
	if( this._drill_EFIE_param == undefined ){ return false; }
	if( this._drill_EFIE_param.playing_type == "" ){ return false; }
	return true;
}
//==============================
// * 物体的属性 - 获取正在播放的类型（开放函数）
//==============================
Game_Character.prototype.drill_EFIE_getPlayingType = function() {
	if( this._drill_EFIE_param == undefined ){ return ""; }
	return this._drill_EFIE_param.playing_type;
}
//==============================
// * 物体的属性 - 设置透明度（开放函数）
//==============================
...
// * 『显现动作』直接显现 - 初始化
//==============================
Game_Character.prototype.drill_EFIE_playShowingAppear = function( allTime ){
	this.drill_EFIE_checkData();
	allTime -= 2;		//『动作效果总时间的时差』
	
	var p_data = this._drill_EFIE_param;
...
// * 『显现动作』移动显现 - 初始化
//==============================
Game_Character.prototype.drill_EFIE_playShowingMoveAppear = function( allTime,angle,distance ){
	this.drill_EFIE_checkData();
	allTime -= 2;		//『动作效果总时间的时差』
...
// * 『显现动作』标准落下 - 初始化
//==============================
Game_Character.prototype.drill_EFIE_playShowingFall = function( allTime,height,bufferTime ){
	this.drill_EFIE_checkData();
	if( bufferTime == undefined ){ bufferTime = 20; }
	if( allTime < bufferTime ){
		alert( DrillUp.drill_EFIE_getPluginTip_allTimeError("标准落下") );
		return;
	}
	allTime -= 2;		//『动作效果总时间的时差』
...
Game_Character.prototype.drill_EFIE_updateShowingFall = function() {
	...
	if( p_data.fA_time < p_data.fA_dest ){
		...
		// > 锚点(0.5,1.0)锁定
		var fix_point = $gameTemp.drill_EFIE_Math2D_getFixPointInAnchor( s_data.anchor_x,s_data.anchor_y, 0.5,1.0, s_data.real_width,s_data.real_height, s_data.rotation, s_data.scale_x+1, s_data.scale_y+1 );
...
// * 『显现动作』标准弹跳 - 初始化
//==============================
Game_Character.prototype.drill_EFIE_playShowingJump = function( allTime, height ){
	this.drill_EFIE_checkData();
	allTime -= 2;		//『动作效果总时间的时差』
...
// * 『显现动作』放大出现 - 初始化
//==============================
Game_Character.prototype.drill_EFIE_playShowingEnlarge = function( allTime, bufferTime, opacity_off ){
	this.drill_EFIE_checkData();
	if( bufferTime == undefined ){ bufferTime = 20; }
	if( allTime < bufferTime ){
		alert( DrillUp.drill_EFIE_getPluginTip_allTimeError("放大出现") );
		return;
	}
	allTime -= 2;		//『动作效果总时间的时差』
...
// * 『显现动作』横向冒出 - 初始化
//==============================
Game_Character.prototype.drill_EFIE_playShowingHorizonFlat = function( allTime, scale_x, opacity_off ){
	this.drill_EFIE_checkData();
	allTime -= 2;		//『动作效果总时间的时差』
...
// * 『显现动作』纵向冒出 - 初始化
//==============================
Game_Character.prototype.drill_EFIE_playShowingVerticalFlat = function( allTime, scale_y, opacity_off ){
	this.drill_EFIE_checkData();
	allTime -= 2;		//『动作效果总时间的时差』
...
// * 『显现动作』弹性放大出现 - 初始化
//==============================
Game_Character.prototype.drill_EFIE_playShowingEnlargeSpring = function( allTime, overflow_scale, anchor_x, anchor_y, opacity_off ){
	this.drill_EFIE_checkData();
	allTime -= 2;		//『动作效果总时间的时差』
	...
	p_data.fA_abc = $gameTemp.drill_EFIE_Math2D_getParabolicThree( 0,-1, allTime*0.8,overflow_scale, allTime,0 );
...
Game_Character.prototype.drill_EFIE_updateShowingEnlargeSpring = function() {
	...
	if( p_data.fA_time < p_data.fA_dest ){
		...
		// > 锚点锁定
		var fix_point = $gameTemp.drill_EFIE_Math2D_getFixPointInAnchor( s_data.anchor_x,s_data.anchor_y, p_data.fA_anchor_x, p_data.fA_anchor_y, s_data.real_width,s_data.real_height, s_data.rotation, s_data.scale_x+1, s_data.scale_y+1 );
		s_data.x = fix_point.x;
		s_data.y = fix_point.y;
...
//==============================
Game_Character.prototype.drill_EFIE_playShowingSpiralMove = function( allTime, numDirection, radius, spiralTime, showTime ){
	this.drill_EFIE_checkData();
	if( allTime < showTime ){
		alert( DrillUp.drill_EFIE_getPluginTip_allTimeError("顺时针/逆时针螺旋显现") );
		return;
	}
	allTime -= 2;		//『动作效果总时间的时差』
...
//==============================
Game_Character.prototype.drill_EFIE_updateShowingSpiralMove = function() {
	var p_data = this._drill_EFIE_param;
	if( p_data == undefined ){ return; }
