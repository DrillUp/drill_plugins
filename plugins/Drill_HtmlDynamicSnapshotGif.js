//=============================================================================
// Drill_HtmlDynamicSnapshotGif.js
//=============================================================================

/*:
 * @plugindesc [v1.1]        游戏窗体 - 天窗层的多层GIF
 * @author Drill_up
 * 
 * @Drill_LE_param "GIF层-%d"
 * @Drill_LE_parentKey "---GIF层组%d至%d---"
 * @Drill_LE_var "DrillUp.g_HDSGi_layers_length"
 * 
 * 
 * @help 
 * =============================================================================
 * +++ Drill_HtmlDynamicSnapshotGif +++
 * 作者：Drill_up
 ...
 *      但不包括天窗层的贴图，以及动态快照自己。
 *   (3.默认情况下 所有GIF 都是隐藏的，需要插件指令手动显示。
 ...
 * 你可以通过插件指令手动修改各个属性：
 * 
 * 插件指令：>天窗层GIF : GIF[11] : 显示
 * 插件指令：>天窗层GIF : GIF变量[21] : 显示
 * 插件指令：>天窗层GIF : 批量GIF[7,8] : 显示
 * 插件指令：>天窗层GIF : 批量GIF变量[21,22] : 显示
 * 插件指令：>天窗层GIF : 全部GIF : 显示
 * 
 * 插件指令：>天窗层GIF : GIF[11] : 显示
 * 插件指令：>天窗层GIF : GIF[11] : 隐藏
 * 插件指令：>天窗层GIF : GIF[11] : 暂停
 * 插件指令：>天窗层GIF : GIF[11] : 继续
 * 插件指令：>天窗层GIF : GIF[11] : 切换混合模式[0]
 * 插件指令：>天窗层GIF : GIF[11] : 还原混合模式
 * 插件指令：>天窗层GIF : GIF[11] : 切换图片层级[10]
 * 插件指令：>天窗层GIF : GIF[11] : 还原图片层级
 * 插件指令：>天窗层GIF : GIF[11] : 修改单属性 : 透明度[255] : 时间[60]
 * 插件指令：>天窗层GIF : GIF[11] : 修改单属性 : 透明度变量[21] : 时间[60]
 * 插件指令：>天窗层GIF : GIF[11] : 修改单属性 : 旋转[90] : 时间[60]
 * 插件指令：>天窗层GIF : GIF[11] : 修改单属性 : 旋转变量[21] : 时间[60]
 * 插件指令：>天窗层GIF : GIF[11] : 修改单属性 : 转速[10.0] : 时间[60]
 * 插件指令：>天窗层GIF : GIF[11] : 修改单属性 : 转速变量[21] : 时间[60]
 * 插件指令：>天窗层GIF : GIF[11] : 修改单属性 : 缩放X[1.2] : 时间[60]
 * 插件指令：>天窗层GIF : GIF[11] : 修改单属性 : 缩放X变量%[21] : 时间[60]
 * 插件指令：>天窗层GIF : GIF[11] : 修改单属性 : 缩放Y[1.2] : 时间[60]
 * 插件指令：>天窗层GIF : GIF[11] : 修改单属性 : 缩放Y变量%[21] : 时间[60]
 * 插件指令：>天窗层GIF : GIF[11] : 修改单属性 : 斜切X[0.2] : 时间[60]
 * 插件指令：>天窗层GIF : GIF[11] : 修改单属性 : 斜切X变量%[21] : 时间[60]
 * 插件指令：>天窗层GIF : GIF[11] : 修改单属性 : 斜切Y[0.2] : 时间[60]
 * 插件指令：>天窗层GIF : GIF[11] : 修改单属性 : 斜切Y变量%[21] : 时间[60]
 * 插件指令：>天窗层GIF : GIF[11] : 立即还原所有单属性
 * 
 ...
 * 你可以通过插件指令手动设置移动：
 * 
 * 插件指令：>天窗层GIF : GIF[11] : 移动到-匀速移动 : 位置[100,100] : 时间[60]
 * 插件指令：>天窗层GIF : GIF[11] : 移动到-匀速移动 : 位置变量[25,26] : 时间[60]
 * 插件指令：>天窗层GIF : GIF[11] : 移动到-弹性移动 : 位置[100,100] : 时间[60]
 * 插件指令：>天窗层GIF : GIF[11] : 移动到-弹性移动 : 位置变量[25,26] : 时间[60]
 * 插件指令：>天窗层GIF : GIF[11] : 移动到-增减速移动 : 位置[100,100] : 时间[60]
 * 插件指令：>天窗层GIF : GIF[11] : 移动到-增减速移动 : 位置变量[25,26] : 时间[60]
 * 插件指令：>天窗层GIF : GIF[11] : 移动到-立即归位
 * 
 ...
 * -----------------------------------------------------------------------------
 * ----可选设定 - 获取属性
 * 你可以通过插件指令来获取 天窗层GIF 的属性值：
 * 
 * 插件指令：>天窗层GIF : GIF[11] : 获取属性 : 位置X : 变量[21]
 * 插件指令：>天窗层GIF : GIF变量[21] : 获取属性 : 位置X : 变量[21]
 * 
 * 插件指令：>天窗层GIF : GIF[11] : 获取属性 : 位置X : 变量[21]
 * 插件指令：>天窗层GIF : GIF[11] : 获取属性 : 位置Y : 变量[21]
 * 插件指令：>天窗层GIF : GIF[11] : 获取属性 : 透明度 : 变量[21]
 * 插件指令：>天窗层GIF : GIF[11] : 获取属性 : 旋转 : 变量[21]
 * 插件指令：>天窗层GIF : GIF[11] : 获取属性 : 转速 : 变量[21]
 * 插件指令：>天窗层GIF : GIF[11] : 获取属性 : 缩放X : 变量%[21]
 * 插件指令：>天窗层GIF : GIF[11] : 获取属性 : 缩放Y : 变量%[21]
 * 插件指令：>天窗层GIF : GIF[11] : 获取属性 : 斜切X : 变量%[21]
 * 插件指令：>天窗层GIF : GIF[11] : 获取属性 : 斜切Y : 变量%[21]
 * 
 ...
 * 你可以通过插件指令手动修改中心锚点：
 * 
 * 插件指令：>天窗层GIF : GIF[11] : 修改中心锚点 : 锚点[0.5,1.0]
 * 插件指令：>天窗层GIF : GIF变量[21] : 修改中心锚点 : 锚点[0.5,1.0]
 * 插件指令：>天窗层GIF : 批量GIF[4,5] : 修改中心锚点 : 锚点[0.5,1.0]
 * 插件指令：>天窗层GIF : 批量GIF变量[21,22] : 修改中心锚点 : 锚点[0.5,1.0]
 * 插件指令：>天窗层GIF : 全部GIF : 修改中心锚点 : 锚点[0.5,1.0]
 * 
 ...
 * 你还可以通过插件指令控制GIF播放：
 * 
 * 插件指令：>天窗层GIF : GIF[11] : 锁定帧
 * 插件指令：>天窗层GIF : GIF[11] : 解锁帧
 * 插件指令：>天窗层GIF : GIF[11] : 设置当前帧 : 当前帧[1]
 * 插件指令：>天窗层GIF : GIF[11] : 设置当前帧 : 当前帧变量[21]
 * 插件指令：>天窗层GIF : GIF[11] : 正向播放一次并停留在末尾帧
 * 插件指令：>天窗层GIF : GIF[11] : 反向播放一次并停留在起始帧
 * 
 * 1.前半部分（GIF[11]）和 后半部分（锁定帧）
 ...
 * 
 * 插件指令：>天窗层GIF : GIF[11] : 隐藏(延迟) : 延迟执行时间[20]
 * 插件指令：>天窗层GIF : GIF变量[21] : 隐藏(延迟) : 延迟执行时间[20]
 * 插件指令：>天窗层GIF : 批量GIF[7,8] : 隐藏(延迟) : 延迟执行时间[20]
 * 插件指令：>天窗层GIF : 批量GIF变量[21,22] : 隐藏(延迟) : 延迟执行时间[20]
 * 插件指令：>天窗层GIF : 全部GIF : 隐藏(延迟) : 延迟执行时间[20]
 * 
 * 插件指令：>天窗层GIF : GIF[11] : 显示(延迟) : 延迟执行时间[20]
 * 插件指令：>天窗层GIF : GIF[11] : 隐藏(延迟) : 延迟执行时间[20]
 * 插件指令：>天窗层GIF : GIF[11] : 暂停(延迟) : 延迟执行时间[20]
 * 插件指令：>天窗层GIF : GIF[11] : 继续(延迟) : 延迟执行时间[20]
 * 插件指令：>天窗层GIF : GIF[11] : 切换混合模式(延迟)[0] : 延迟执行时间[20]
 * 插件指令：>天窗层GIF : GIF[11] : 还原混合模式(延迟) : 延迟执行时间[20]
 * 插件指令：>天窗层GIF : GIF[11] : 切换图片层级(延迟)[10] : 延迟执行时间[20]
 * 插件指令：>天窗层GIF : GIF[11] : 还原图片层级(延迟) : 延迟执行时间[20]
 * 插件指令：>天窗层GIF : GIF[11] : 修改单属性(延迟) : 透明度[255] : 时间[60] : 延迟执行时间[20]
 * 插件指令：>天窗层GIF : GIF[11] : 修改单属性(延迟) : 透明度变量[21] : 时间[60] : 延迟执行时间[20]
 * 插件指令：>天窗层GIF : GIF[11] : 修改单属性(延迟) : 旋转[90] : 时间[60] : 延迟执行时间[20]
 * 插件指令：>天窗层GIF : GIF[11] : 修改单属性(延迟) : 旋转变量[21] : 时间[60] : 延迟执行时间[20]
 * 插件指令：>天窗层GIF : GIF[11] : 修改单属性(延迟) : 转速[10.0] : 时间[60] : 延迟执行时间[20]
 * 插件指令：>天窗层GIF : GIF[11] : 修改单属性(延迟) : 转速变量[21] : 时间[60] : 延迟执行时间[20]
 * 插件指令：>天窗层GIF : GIF[11] : 修改单属性(延迟) : 缩放X[1.2] : 时间[60] : 延迟执行时间[20]
 * 插件指令：>天窗层GIF : GIF[11] : 修改单属性(延迟) : 缩放X变量%[21] : 时间[60] : 延迟执行时间[20]
 * 插件指令：>天窗层GIF : GIF[11] : 修改单属性(延迟) : 缩放Y[1.2] : 时间[60] : 延迟执行时间[20]
 * 插件指令：>天窗层GIF : GIF[11] : 修改单属性(延迟) : 缩放Y变量%[21] : 时间[60] : 延迟执行时间[20]
 * 插件指令：>天窗层GIF : GIF[11] : 修改单属性(延迟) : 斜切X[0.2] : 时间[60] : 延迟执行时间[20]
 * 插件指令：>天窗层GIF : GIF[11] : 修改单属性(延迟) : 斜切X变量%[21] : 时间[60] : 延迟执行时间[20]
 * 插件指令：>天窗层GIF : GIF[11] : 修改单属性(延迟) : 斜切Y[0.2] : 时间[60] : 延迟执行时间[20]
 * 插件指令：>天窗层GIF : GIF[11] : 修改单属性(延迟) : 斜切Y变量%[21] : 时间[60] : 延迟执行时间[20]
 * 插件指令：>天窗层GIF : GIF[11] : 还原所有单属性(延迟) : 延迟执行时间[20]
 * 插件指令：>天窗层GIF : GIF[11] : 立即取消全部延迟指令
 * 
 ...
 * 
 * 插件指令：>天窗层GIF : GIF[11] : 移动到(延迟)-匀速移动 : 位置[100,100] : 时间[60] : 延迟执行时间[20]
 * 插件指令：>天窗层GIF : GIF[11] : 移动到(延迟)-匀速移动 : 位置变量[25,26] : 时间[60] : 延迟执行时间[20]
 * 插件指令：>天窗层GIF : GIF[11] : 移动到(延迟)-弹性移动 : 位置[100,100] : 时间[60] : 延迟执行时间[20]
 * 插件指令：>天窗层GIF : GIF[11] : 移动到(延迟)-弹性移动 : 位置变量[25,26] : 时间[60] : 延迟执行时间[20]
 * 插件指令：>天窗层GIF : GIF[11] : 移动到(延迟)-增减速移动 : 位置[100,100] : 时间[60] : 延迟执行时间[20]
 * 插件指令：>天窗层GIF : GIF[11] : 移动到(延迟)-增减速移动 : 位置变量[25,26] : 时间[60] : 延迟执行时间[20]
 * 插件指令：>天窗层GIF : GIF[11] : 移动到(延迟)-延迟归位 : 延迟执行时间[20]
 * 
 ...
 * 
 * 插件指令：>天窗层GIF : GIF[11] : 锁定帧(延迟) : 延迟执行时间[20]
 * 插件指令：>天窗层GIF : GIF[11] : 解锁帧(延迟) : 延迟执行时间[20]
 * 插件指令：>天窗层GIF : GIF[11] : 设置帧(延迟) : 当前帧[1] : 延迟执行时间[20]
 * 插件指令：>天窗层GIF : GIF[11] : 设置帧(延迟) : 当前帧变量[21] : 延迟执行时间[20]
 * 插件指令：>天窗层GIF : GIF[11] : 正向播放一次并停留在末尾帧(延迟) : 延迟执行时间[20]
 * 插件指令：>天窗层GIF : GIF[11] : 反向播放一次并停留在起始帧(延迟) : 延迟执行时间[20]
 * 
 * 1.前半部分（GIF[11]）和 后半部分（锁定帧(延迟) : 延迟执行时间[20]）
 *   的参数可以随意组合，一共有5*6种组合方式。
 * 2.注意，该插件能在 菜单界面 中工作，也就是说，延迟的指令在菜单界面也有效。
 * 
 * -----------------------------------------------------------------------------
 ...
 * 上述的插件指令中，你还可以设置增加延迟：
 * 
 * 插件指令：>天窗层GIF : GIF[11] : 全部延迟指令增加延迟 : 时间[10]
 * 插件指令：>天窗层GIF : GIF[11] : 全部延迟指令增加延迟 : 时间[周期播放完的时间]
 * 
 * 1.前半部分（GIF[11]）和 后半部分（全部延迟指令增加延迟 : 时间[10]）
 ...
 * 
 * 插件指令：>天窗层GIF : GIF[11] : 添加周期-隐藏(周期) : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>天窗层GIF : GIF变量[21] : 添加周期-隐藏(周期) : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>天窗层GIF : 批量GIF[7,8] : 添加周期-隐藏(周期) : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>天窗层GIF : 批量GIF变量[21,22] : 添加周期-隐藏(周期) : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>天窗层GIF : 全部GIF : 添加周期-隐藏(周期) : 周期时长[90] : 周期内开始时间[0]
 * 
 * 插件指令：>天窗层GIF : GIF[11] : 添加周期-显示(周期) : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>天窗层GIF : GIF[11] : 添加周期-隐藏(周期) : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>天窗层GIF : GIF[11] : 添加周期-暂停(周期) : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>天窗层GIF : GIF[11] : 添加周期-继续(周期) : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>天窗层GIF : GIF[11] : 添加周期-切换混合模式(周期)[0] : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>天窗层GIF : GIF[11] : 添加周期-还原混合模式(周期) : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>天窗层GIF : GIF[11] : 添加周期-切换图片层级(周期)[10] : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>天窗层GIF : GIF[11] : 添加周期-还原图片层级(周期) : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>天窗层GIF : GIF[11] : 添加周期-修改单属性(周期) : 透明度[255] : 时间[60] : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>天窗层GIF : GIF[11] : 添加周期-修改单属性(周期) : 透明度变量[21] : 时间[60] : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>天窗层GIF : GIF[11] : 添加周期-修改单属性(周期) : 旋转[90] : 时间[60] : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>天窗层GIF : GIF[11] : 添加周期-修改单属性(周期) : 旋转变量[21] : 时间[60] : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>天窗层GIF : GIF[11] : 添加周期-修改单属性(周期) : 转速[10.0] : 时间[60] : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>天窗层GIF : GIF[11] : 添加周期-修改单属性(周期) : 转速变量[21] : 时间[60] : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>天窗层GIF : GIF[11] : 添加周期-修改单属性(周期) : 缩放X[1.2] : 时间[60] : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>天窗层GIF : GIF[11] : 添加周期-修改单属性(周期) : 缩放X变量%[21] : 时间[60] : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>天窗层GIF : GIF[11] : 添加周期-修改单属性(周期) : 缩放Y[1.2] : 时间[60] : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>天窗层GIF : GIF[11] : 添加周期-修改单属性(周期) : 缩放Y变量%[21] : 时间[60] : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>天窗层GIF : GIF[11] : 添加周期-修改单属性(周期) : 斜切X[0.2] : 时间[60] : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>天窗层GIF : GIF[11] : 添加周期-修改单属性(周期) : 斜切X变量%[21] : 时间[60] : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>天窗层GIF : GIF[11] : 添加周期-修改单属性(周期) : 斜切Y[0.2] : 时间[60] : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>天窗层GIF : GIF[11] : 添加周期-修改单属性(周期) : 斜切Y变量%[21] : 时间[60] : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>天窗层GIF : GIF[11] : 添加周期-还原所有单属性(周期) : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>天窗层GIF : GIF[11] : 暂停周期指令
 * 插件指令：>天窗层GIF : GIF[11] : 继续周期指令
 * 插件指令：>天窗层GIF : GIF[11] : 清空周期指令(立刻)
 * 
 * 1.前半部分（GIF[11]）和 后半部分（ 添加周期-隐藏(周期) ）
 ...
 * 
 * 插件指令：>天窗层GIF : GIF[11] : 添加周期-移动到(周期)-匀速移动 : 位置[100,100] : 时间[60] : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>天窗层GIF : GIF[11] : 添加周期-移动到(周期)-匀速移动 : 位置变量[25,26] : 时间[60] : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>天窗层GIF : GIF[11] : 添加周期-移动到(周期)-弹性移动 : 位置[100,100] : 时间[60] : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>天窗层GIF : GIF[11] : 添加周期-移动到(周期)-弹性移动 : 位置变量[25,26] : 时间[60] : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>天窗层GIF : GIF[11] : 添加周期-移动到(周期)-增减速移动 : 位置[100,100] : 时间[60] : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>天窗层GIF : GIF[11] : 添加周期-移动到(周期)-增减速移动 : 位置变量[25,26] : 时间[60] : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>天窗层GIF : GIF[11] : 添加周期-移动到(周期)-执行归位 : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>天窗层GIF : GIF[11] : 暂停周期指令
 * 插件指令：>天窗层GIF : GIF[11] : 继续周期指令
 * 插件指令：>天窗层GIF : GIF[11] : 清空周期指令(立刻)
 * 
 * 1.前半部分（GIF[11]）和 后半部分（ 添加周期-移动到(周期)-匀速移动 ）
 ...
 * 
 * 插件指令：>天窗层GIF : GIF[11] : 添加周期-锁定帧(周期) : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>天窗层GIF : GIF[11] : 添加周期-解锁帧(周期) : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>天窗层GIF : GIF[11] : 添加周期-设置帧(周期) : 当前帧[1] : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>天窗层GIF : GIF[11] : 添加周期-设置帧(周期) : 当前帧变量[21] : 周期时长[90] : 周期内开始时间[0]
 * 插件指令：>天窗层GIF : GIF[11] : 暂停周期指令
 * 插件指令：>天窗层GIF : GIF[11] : 继续周期指令
 * 插件指令：>天窗层GIF : GIF[11] : 清空周期指令(立刻)
 * 
 * 1.前半部分（GIF[11]）和 后半部分（ 添加周期-锁定帧(周期) ）
 *   的参数可以随意组合，一共有5*7种组合方式。
 * 2.注意，该插件能在 菜单界面 中工作，也就是说，延迟的指令在菜单界面也有效。
 * 
 * -----------------------------------------------------------------------------
 ...
 * 上述的插件指令中，可以设置：
 * 
 * 插件指令：>天窗层GIF : GIF[11] : 暂停周期指令(延迟) : 延迟执行时间[20]
 * 插件指令：>天窗层GIF : GIF[11] : 继续周期指令(延迟) : 延迟执行时间[20]
 * 插件指令：>天窗层GIF : GIF[11] : 清空周期指令(延迟) : 延迟执行时间[20]
 * 
 * 1.前半部分（GIF[11]）和 后半部分（ 暂停周期指令(延迟) : 延迟执行时间[20] ）
 ...
 * 上述的插件指令中，可以设置：
 * 
 * 插件指令：>天窗层GIF : GIF[11] : 暂停周期指令(周期末尾时)
 * 插件指令：>天窗层GIF : GIF[11] : 清空周期指令(周期末尾时)
 * 插件指令：>天窗层GIF : GIF[11] : 执行等待(周期末尾时)
 * 
 ...
 * 测试方法1：  在地图中放置多个GIF，进行性能测试。
 * 测试结果1：  200个事件的地图中，平均消耗为：【41.90ms】
 *              100个事件的地图中，平均消耗为：【37.31ms】
 *               50个事件的地图中，平均消耗为：【32.26ms】
 * 测试方法2：  在不同的界面中，进行性能测试。
 * 测试结果2：  战斗界面中，平均消耗为：【18.60ms】
 *              菜单界面中，平均消耗为：【13.60ms】
 *
 * 1.插件只在自己作用域下工作消耗性能，在其它作用域下是不工作的。
 *   测试结果并不是精确值，范围在给定值的10ms范围内波动。
 *   更多性能介绍，去看看 "0.性能测试报告 > 关于插件性能.docx"。
 * 2.GIF是一个简单贴图，只不过放在了天窗层而已，消耗并不大。
 *
 * -----------------------------------------------------------------------------
 * ----更新日志
 * [v1.0]
...
//<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
//
//		插件简称		HDSGi（Html_Dynamic_Snapshot_Gif）
//		覆盖重写方法	无
//
//<<<<<<<<性能记录<<<<<<<<
//
...
//		★性能测试因素	特效管理层
//		★性能测试消耗	2026/2/11：
//							》共41.9ms（Drill_HDSGi_Sprite.update），其中部分18.6ms（drill_sprite_getGIFBitmapByIndex）13.6ms（drill_HDSGi_updateController）
//		★最坏情况		暂无
//		★备注			这个贴图一般都长期挂着，时间长了会导致一定的消耗。
//		
//		★优化记录		暂无
//
//<<<<<<<<插件记录<<<<<<<<
...
//				->销毁
//			
//			->天窗层GIF控制器【Drill_HDSGi_Controller】
//			->天窗层GIF贴图【Drill_HDSGi_Sprite】
//
//
//		★家谱：
//			大家族-屏幕快照
...
//=============================================================================
	...
	//==============================
	var DrillUp = DrillUp || {}; 
	DrillUp.g_HDSGi_PluginTip_curName = "Drill_HtmlDynamicSnapshotGif.js 游戏窗体-天窗层的多层GIF";
	DrillUp.g_HDSGi_PluginTip_baseList = [
	...
	//==============================
	DrillUp.drill_HDSGi_getPluginTip_NoBasePlugin = function(){
		if( DrillUp.g_HDSGi_PluginTip_baseList.length == 0 ){ return ""; }
		var message = "【" + DrillUp.g_HDSGi_PluginTip_curName + "】\n缺少基础插件，去看看下列插件是不是 未添加 / 被关闭 / 顺序不对：";
		for(var i=0; i < DrillUp.g_HDSGi_PluginTip_baseList.length; i++){
			message += "\n- ";
			message += DrillUp.g_HDSGi_PluginTip_baseList[i];
		}
		return message;
	};
	//==============================
	// * 提示信息 - 报错 - 找不到样式
	//==============================
	DrillUp.drill_HDSGi_getPluginTip_StyleNotFind = function( style_id ){
		return "【" + DrillUp.g_HDSGi_PluginTip_curName + "】\n对象创建失败，id为"+style_id+"的样式配置为空或不存在。";
	};
	//==============================
	// * 提示信息 - 报错 - NaN校验值
	//==============================
	DrillUp.drill_HDSGi_getPluginTip_ParamIsNaN = function( param_name, check_tank ){
		var text = "【" + DrillUp.g_HDSGi_PluginTip_curName + "】\n检测到参数"+param_name+"出现了NaN值，请及时检查你的函数。";
		if( check_tank ){
	...
	// * 提示信息 - 报错 - 底层版本过低
	//==============================
	DrillUp.drill_HDSGi_getPluginTip_LowVersion = function(){
		return "【" + DrillUp.g_HDSGi_PluginTip_curName + "】\n游戏底层版本过低，插件基本功能无法执行。\n你可以去看\"rmmv软件版本（必看）.docx\"中的 \"旧工程升级至1.6版本\" 章节，来升级你的游戏底层版本。";
	};
	//==============================
	// * 提示信息 - 报错 - 强制更新提示
	//==============================
	DrillUp.drill_HDSGi_getPluginTip_NeedUpdate_Ballistics = function(){
		return "【" + DrillUp.g_HDSGi_PluginTip_curName + "】\n弹道核心插件版本过低，你需要更新 弹道核心 至少v2.2及以上版本。";
	};
	//==============================
	// * 提示信息 - 报错 - 控制器的非数字参数
	//==============================
	DrillUp.drill_HDSGi_getPluginTip_controllerData_NotId = function( class_name ){
...
//=============================================================================
	...
	Imported.Drill_HtmlDynamicSnapshotGif = true;
	var DrillUp = DrillUp || {}; 
	DrillUp.parameters = PluginManager.parameters('Drill_HtmlDynamicSnapshotGif');
	
	//==============================
	// * 静态数据 - GIF
	//				（~struct~HDSGiLayer）
	//==============================
	DrillUp.drill_HDSGi_gifInit = function( dataFrom ){
		var data = {};
		...
		Drill_HDSGi_Controller.drill_controller_initData( data );
	...
	// * 静态数据 - 最后继承1级
	//==============================
	var _drill_HDSGi_scene_initialize = SceneManager.initialize;
	SceneManager.initialize = function() {
		_drill_HDSGi_scene_initialize.call(this);
		
		/*-----------------GIF------------------*/
		for( var i = 0; i < DrillUp.g_HDSGi_layers.length; i++ ){
			var temp = DrillUp.g_HDSGi_layers[i];
			if( temp != undefined ){
				DrillUp.g_HDSGi_layers[i] = DrillUp.drill_HDSGi_gifInit( temp );
			}
		}
	}
	/*-----------------GIF------------------*/
	DrillUp.g_HDSGi_layers_length = 80;
	DrillUp.g_HDSGi_layers = [];
	for (var i = 0; i < DrillUp.g_HDSGi_layers_length; i++) {
		if( DrillUp.parameters["GIF层-" + String(i+1) ] != undefined &&
			DrillUp.parameters["GIF层-" + String(i+1) ] != "" ){
			DrillUp.g_HDSGi_layers[i] = JSON.parse(DrillUp.parameters["GIF层-" + String(i+1) ]);
		}else{
			DrillUp.g_HDSGi_layers[i] = undefined;		//（设为空值，节约静态数据占用容量）
		}
	}

	/*-----------------杂项------------------*/
	DrillUp.g_HDSGi_saveEnabled = String(DrillUp.parameters["是否开启参数存储"] || "false") == "true" ;
...
if( Imported.Drill_CoreOfDynamicSnapshot &&
	...
	if( typeof(Drill_COBa_ExtendTool) == "undefined" ){	//（弹道核心版本检测）
		alert( DrillUp.drill_HDSGi_getPluginTip_NeedUpdate_Ballistics() );
	}
...
// * 插件指令 - 指令绑定
//==============================
var _drill_HDSGi_pluginCommand = Game_Interpreter.prototype.pluginCommand;
Game_Interpreter.prototype.pluginCommand = function( command, args ){
	_drill_HDSGi_pluginCommand.call(this, command, args);
	this.drill_HDSGi_pluginCommand( command, args );
}
//==============================
// * 插件指令 - 指令执行
//==============================
Game_Interpreter.prototype.drill_HDSGi_pluginCommand = function( command, args ){
	DrillUp.drill_HDSGi_globalPluginCommand( command, args, this );
}
//==============================
// * 插件指令 - 『作用全局的插件指令』
//
...
//==============================
DrillUp.drill_HDSGi_globalPluginCommand = function( command, args, gameInterpreter ){
	if( command === ">天窗层GIF" ){ // >天窗层GIF : GIF[1] : 显示
		...
		if( args.length >= 2 ){
			...
			if( controllers == null && unit.indexOf("批量GIF[") != -1 ){
				...
				for( var k=0; k < temp_arr.length; k++ ){
					...
					var temp_controller = $gameSystem._drill_HDSGi_controllerTank[ controller_id -1 ];
			...
			if( controllers == null && unit == "全部GIF" ){
				controllers = [];
				for( var k=0; k < $gameSystem._drill_HDSGi_controllerTank.length; k++ ){
					var temp_controller = $gameSystem._drill_HDSGi_controllerTank[ k ];
					if( temp_controller == undefined ){ continue; }
					controllers.push( temp_controller );
				}
			}
		...
		if( args.length == 8 ){
			...
			if( type == "修改单属性" ){
				...
				if( temp1.indexOf("透明度[") != -1 ||
					...
					var num_list = DrillUp.drill_HDSGi_getArgNumList(temp1);
					for( var k=0; k < controllers.length; k++ ){
		...
		if( args.length == 6 ){
			...
			if( type == "显示(延迟)" ){
				...
				for( var k=0; k < controllers.length; k++ ){
					controllers[k].drill_controller_setDelayingCommand(
						Drill_HDSGi_Controller.METHOD__drill_controller_setVisible, [true], delay_time
					);
				}
			}
			if( type == "隐藏(延迟)" ){
				...
				for( var k=0; k < controllers.length; k++ ){
					controllers[k].drill_controller_setDelayingCommand(
						Drill_HDSGi_Controller.METHOD__drill_controller_setVisible, [false], delay_time
					);
				}
			}
			if( type == "暂停(延迟)" ){
				...
				for( var k=0; k < controllers.length; k++ ){
					controllers[k].drill_controller_setDelayingCommand(
						Drill_HDSGi_Controller.METHOD__drill_controller_setPause, [true], delay_time
					);
				}
			}
			if( type == "继续(延迟)" ){
				...
				for( var k=0; k < controllers.length; k++ ){
					controllers[k].drill_controller_setDelayingCommand(
						Drill_HDSGi_Controller.METHOD__drill_controller_setPause, [false], delay_time
					);
				}
			}
			if( type == "暂停周期指令(延迟)" ){
				...
				for( var k=0; k < controllers.length; k++ ){
					controllers[k].drill_controller_setDelayingCommand(
						Drill_HDSGi_Controller.METHOD__drill_controller_periodizeCommand_setPause, [true], delay_time
					);
				}
			}
			if( type == "继续周期指令(延迟)" ){
				...
				for( var k=0; k < controllers.length; k++ ){
					controllers[k].drill_controller_setDelayingCommand(
						Drill_HDSGi_Controller.METHOD__drill_controller_periodizeCommand_setPause, [false], delay_time
					);
				}
			}
			if( type == "清空周期指令(延迟)" ){
				...
				for( var k=0; k < controllers.length; k++ ){
					controllers[k].drill_controller_setDelayingCommand(
						Drill_HDSGi_Controller.METHOD__drill_controller_periodizeCommand_clear, [], delay_time
					);
				}
			}
			...
			if( type.indexOf("切换混合模式(延迟)[") != -1 ){
				...
				for( var k=0; k < controllers.length; k++ ){
					controllers[k].drill_controller_setDelayingCommand(
						Drill_HDSGi_Controller.METHOD__drill_controller_setBlendMode, [Number(type)], delay_time
					);
				}
			}
			if( type.indexOf("切换图片层级(延迟)[") != -1 ){
				...
				for( var k=0; k < controllers.length; k++ ){
					controllers[k].drill_controller_setDelayingCommand(
						Drill_HDSGi_Controller.METHOD__drill_controller_setZIndex, [Number(type)], delay_time
					);
				}
			}
			if( type == "还原混合模式(延迟)" ){
				...
				for( var k=0; k < controllers.length; k++ ){
					controllers[k].drill_controller_setDelayingCommand(
						Drill_HDSGi_Controller.METHOD__drill_controller_restoreBlendMode, [], delay_time
					);
				}
			}
			if( type == "还原图片层级(延迟)" ){
				...
				for( var k=0; k < controllers.length; k++ ){
					controllers[k].drill_controller_setDelayingCommand(
						Drill_HDSGi_Controller.METHOD__drill_controller_restoreZIndex, [], delay_time
					);
				}
			}
			if( type == "还原所有单属性(延迟)" ){
				...
				for( var k=0; k < controllers.length; k++ ){
					controllers[k].drill_controller_setDelayingCommand(
						Drill_HDSGi_Controller.METHOD__drill_controller_commandChange_restoreAttr, [], delay_time
					);
				}
			}
			if( type == "移动到(延迟)-延迟归位" ){
				...
				for( var k=0; k < controllers.length; k++ ){
					controllers[k].drill_controller_setDelayingCommand(
						Drill_HDSGi_Controller.METHOD__drill_controller_commandChange_restoreMove, [], delay_time
					);
				}
			}
		}
		if( args.length == 10 ){
			...
			if( type == "修改单属性(延迟)" ){
				...
				if( temp1.indexOf("透明度[") != -1 ||
					...
					for( var k=0; k < controllers.length; k++ ){
						controllers[k].drill_controller_setDelayingCommand(
							Drill_HDSGi_Controller.METHOD__drill_controller_commandChange_setOpacity, 
				...
				if( temp1.indexOf("旋转[") != -1 ||
					...
					for( var k=0; k < controllers.length; k++ ){
						controllers[k].drill_controller_setDelayingCommand(
							Drill_HDSGi_Controller.METHOD__drill_controller_commandChange_setRotate,
							[ "匀速变化", num_list[0], Number(temp2) ], delay_time
						);
					}
				}
				if( temp1.indexOf("转速[") != -1 ||
					...
					for( var k=0; k < controllers.length; k++ ){
						controllers[k].drill_controller_setDelayingCommand(
							Drill_HDSGi_Controller.METHOD__drill_controller_commandChange_setRotateSpeed,
							["匀速变化", num_list[0], Number(temp2) ], delay_time
						);
					}
				}
				if( temp1.indexOf("缩放X[") != -1 ||
					...
					for( var k=0; k < controllers.length; k++ ){
						controllers[k].drill_controller_setDelayingCommand(
							Drill_HDSGi_Controller.METHOD__drill_controller_commandChange_setScaleX,
							[ "匀速变化", num_list[0], Number(temp2) ], delay_time
						);
					}
				}
				if( temp1.indexOf("缩放Y[") != -1 ||
					...
					for( var k=0; k < controllers.length; k++ ){
						controllers[k].drill_controller_setDelayingCommand(
							Drill_HDSGi_Controller.METHOD__drill_controller_commandChange_setScaleY,
							[ "匀速变化", num_list[0], Number(temp2) ], delay_time
						);
					}
				}
				if( temp1.indexOf("斜切X[") != -1 ||
					...
					for( var k=0; k < controllers.length; k++ ){
						controllers[k].drill_controller_setDelayingCommand(
							Drill_HDSGi_Controller.METHOD__drill_controller_commandChange_setSkewX,
							[ "匀速变化", num_list[0], Number(temp2) ], delay_time
						);
					}
				}
				if( temp1.indexOf("斜切Y[") != -1 ||
					...
					for( var k=0; k < controllers.length; k++ ){
						controllers[k].drill_controller_setDelayingCommand(
							Drill_HDSGi_Controller.METHOD__drill_controller_commandChange_setSkewY,
							[ "匀速变化", num_list[0], Number(temp2) ], delay_time
						);
					}
				}
			...
			if( type == "移动到(延迟)-匀速移动" ){
				...
				if( temp1.indexOf("位置[") != -1 ||
					...
					for( var k=0; k < controllers.length; k++ ){
						controllers[k].drill_controller_setDelayingCommand(
							Drill_HDSGi_Controller.METHOD__drill_controller_commandChange_setMove,
		...
		if( args.length == 6 ){
			...
			if( type == "锁定帧(延迟)" ){
				for( var k=0; k < controllers.length; k++ ){
					controllers[k].drill_controller_setDelayingCommand(
						Drill_HDSGi_Controller.METHOD__drill_controller_GIF_setLocked,
						[ true ], delay_time
					);
				}
			}
			...
			if( type == "正向播放一次并停留在末尾帧(延迟)" ){
				for( var k=0; k < controllers.length; k++ ){
					controllers[k].drill_controller_setDelayingCommand(
						Drill_HDSGi_Controller.METHOD__drill_controller_GIF_setOncePlay,
		...
		if( args.length == 8 ){
			...
			if( type == "设置帧(延迟)" || type == "设置当前帧(延迟)" ){
				for( var k=0; k < controllers.length; k++ ){
					controllers[k].drill_controller_setDelayingCommand(
						Drill_HDSGi_Controller.METHOD__drill_controller_GIF_setFrame,
		...
		if( args.length == 8 ){
			...
			if( type == "添加周期-显示(周期)" ){
				...
				for( var k=0; k < controllers.length; k++ ){
					controllers[k].drill_controller_setPeriodizeCommand(
						Drill_HDSGi_Controller.METHOD__drill_controller_setVisible, [true], time_period, time_start
					);
				}
			}
			if( type == "添加周期-隐藏(周期)" ){
				...
				for( var k=0; k < controllers.length; k++ ){
					controllers[k].drill_controller_setPeriodizeCommand(
						Drill_HDSGi_Controller.METHOD__drill_controller_setVisible, [false], time_period, time_start
					);
				}
			}
			if( type == "添加周期-暂停(周期)" ){
				...
				for( var k=0; k < controllers.length; k++ ){
					controllers[k].drill_controller_setPeriodizeCommand(
						Drill_HDSGi_Controller.METHOD__drill_controller_setPause, [true], time_period, time_start
					);
				}
			}
			if( type == "添加周期-继续(周期)" ){
				...
				for( var k=0; k < controllers.length; k++ ){
					controllers[k].drill_controller_setPeriodizeCommand(
						Drill_HDSGi_Controller.METHOD__drill_controller_setPause, [false], time_period, time_start
					);
				}
			}
			if( type.indexOf("添加周期-切换混合模式(周期)[") != -1 ){
				...
				for( var k=0; k < controllers.length; k++ ){
					controllers[k].drill_controller_setPeriodizeCommand(
						Drill_HDSGi_Controller.METHOD__drill_controller_setBlendMode, [Number(type)], time_period, time_start
					);
				}
			}
			if( type.indexOf("添加周期-切换图片层级(周期)[") != -1 ){
				...
				for( var k=0; k < controllers.length; k++ ){
					controllers[k].drill_controller_setPeriodizeCommand(
						Drill_HDSGi_Controller.METHOD__drill_controller_setZIndex, [Number(type)], time_period, time_start
					);
				}
			}
			if( type == "添加周期-还原混合模式(周期)" ){
				...
				for( var k=0; k < controllers.length; k++ ){
					controllers[k].drill_controller_setPeriodizeCommand(
						Drill_HDSGi_Controller.METHOD__drill_controller_restoreBlendMode, [], time_period, time_start
					);
				}
			}
			if( type == "添加周期-还原图片层级(周期)" ){
				...
				for( var k=0; k < controllers.length; k++ ){
					controllers[k].drill_controller_setPeriodizeCommand(
						Drill_HDSGi_Controller.METHOD__drill_controller_restoreZIndex, [], time_period, time_start
					);
				}
			}
			if( type == "添加周期-还原所有单属性(周期)" ){
				...
				for( var k=0; k < controllers.length; k++ ){
					controllers[k].drill_controller_setPeriodizeCommand(
						Drill_HDSGi_Controller.METHOD__drill_controller_commandChange_restoreAttr, [], time_period, time_start
					);
				}
			}
			if( type == "添加周期-移动到(周期)-执行归位" ){
				...
				for( var k=0; k < controllers.length; k++ ){
					controllers[k].drill_controller_setPeriodizeCommand(
						Drill_HDSGi_Controller.METHOD__drill_controller_commandChange_restoreMove, [], time_period, time_start
					);
				}
			}
		}
...
//==============================
DrillUp.drill_HDSGi_getArgNumList = function( arg_str ){
...
// * 预加载 - 初始化
//==============================
var _drill_HDSGi_preload_initialize = Game_Temp.prototype.initialize;
Game_Temp.prototype.initialize = function(){
	_drill_HDSGi_preload_initialize.call(this);
	this.drill_HDSGi_preloadInit();
}
//==============================
// * 预加载 - 版本校验
//==============================
if( Utils.generateRuntimeId == undefined ){
	alert( DrillUp.drill_HDSGi_getPluginTip_LowVersion() );
}
//==============================
// * 预加载 - 执行资源预加载
//
...
//==============================
Game_Temp.prototype.drill_HDSGi_preloadInit = function(){
	this._drill_HDSGi_cacheId = Utils.generateRuntimeId();	//资源缓存id
	this._drill_HDSGi_preloadTank = [];						//bitmap容器
	for( var i = 0; i < DrillUp.g_HDSGi_layers.length; i++ ){
		var temp_data = DrillUp.g_HDSGi_layers[i];
		...
		if( temp_data['preloadType'] == "全部预加载" ){
			...
			for( var k = 0; k < src_img_num; k++ ){
				this._drill_HDSGi_preloadTank.push( 
					ImageManager.reserveBitmap( temp_data['src_img_file'], temp_data['src_img_gif'][k], temp_data['tint'], temp_data['smooth'], this._drill_HDSGi_cacheId ) 
				);
			}
		}
...
//##############################
//DrillUp.g_HDSGi_saveEnabled = true;
//##############################
// * 存储数据 - 初始化
//          
//			说明：	> 下方为固定写法，不要动。
//##############################
var _drill_HDSGi_sys_initialize = Game_System.prototype.initialize;
Game_System.prototype.initialize = function(){
    _drill_HDSGi_sys_initialize.call(this);
	this.drill_HDSGi_initSysData();
};
//##############################
// * 存储数据 - 载入存档
//          
//			说明：	> 下方为固定写法，不要动。
//##############################
var _drill_HDSGi_sys_extractSaveContents = DataManager.extractSaveContents;
DataManager.extractSaveContents = function( contents ){
	_drill_HDSGi_sys_extractSaveContents.call( this, contents );
	
	// > 参数存储 启用时（检查数据）
	if( DrillUp.g_HDSGi_saveEnabled == true ){	
		$gameSystem.drill_HDSGi_checkSysData();
		
	// > 参数存储 关闭时（直接覆盖）
	}else{
		$gameSystem.drill_HDSGi_initSysData();
	}
};
//##############################
// * 存储数据 - 初始化数据【标准函数】
...
//##############################
Game_System.prototype.drill_HDSGi_initSysData = function(){
	this.drill_HDSGi_initSysData_Private();
};
//##############################
// * 存储数据 - 载入存档时检查数据【标准函数】
//			
...
//##############################
Game_System.prototype.drill_HDSGi_checkSysData = function(){
	this.drill_HDSGi_checkSysData_Private();
};
//=============================================================================
// ** 存储数据（接口实现）
//=============================================================================
...
// * 存储数据 - 初始化数据（私有）
//==============================
Game_System.prototype.drill_HDSGi_initSysData_Private = function(){
	
	this._drill_HDSGi_controllerTank = [];	//当前容器（与 g_HDSGi_layers 依次对应，容器允许出现null值）
	for(var i = 0; i < DrillUp.g_HDSGi_layers.length; i++){
		var temp_data = DrillUp.g_HDSGi_layers[i];
		if( temp_data == undefined ){ continue; }
		
		var temp_controller = new Drill_HDSGi_Controller( i );
		this._drill_HDSGi_controllerTank[i] = temp_controller;
	}
};
//==============================
// * 存储数据 - 载入存档时检查数据（私有）
//==============================
Game_System.prototype.drill_HDSGi_checkSysData_Private = function(){
	
	// > 旧存档数据自动补充
	if( this._drill_HDSGi_controllerTank == undefined ){
		this.drill_HDSGi_initSysData();
	}
	...
	for(var i = 0; i < DrillUp.g_HDSGi_layers.length; i++ ){
		...
		// > 未存储的，重新初始化
		if( this._drill_HDSGi_controllerTank[i] == undefined ){
			var temp_controller = new Drill_HDSGi_Controller( i );
			this._drill_HDSGi_controllerTank[i] = temp_controller;
...
// * 控制器与贴图 - 容器初始化
//==============================
var _drill_HDSGi_temp_initialize2 = Game_Temp.prototype.initialize;
Game_Temp.prototype.initialize = function(){
	_drill_HDSGi_temp_initialize2.call(this);
	this._drill_HDSGi_spriteTank = [];			//贴图容器
...
//==============================
var _drill_HDSGi_smap_terminate = Scene_Map.prototype.terminate;
Scene_Map.prototype.terminate = function(){
	_drill_HDSGi_smap_terminate.call(this);
	$gameTemp._drill_HDSGi_spriteTank = [];		//贴图容器
	Graphics.drill_CODS_overstoryLayerClear();	//清空 天窗层
};
//==============================
// * 控制器与贴图 - 帧刷新『多场景与游戏窗体-地图界面』
//==============================
var _drill_HDSGi_smap_update = Scene_Map.prototype.update;
Scene_Map.prototype.update = function(){
	_drill_HDSGi_smap_update.call(this);
	this.drill_HDSGi_updateController();		//帧刷新 - 控制器
	this.drill_HDSGi_updateAttr();				//帧刷新 - 基础特性
	this.drill_HDSGi_updateDestroy();			//帧刷新 - 销毁
};
//==============================
// * 控制器与贴图 - 界面创建时『多场景与游戏窗体-地图界面』
//==============================
var _drill_HDSGi_smap_createAllWindows = Scene_Map.prototype.createAllWindows;
Scene_Map.prototype.createAllWindows = function(){
	_drill_HDSGi_smap_createAllWindows.call(this);
	this.drill_HDSGi_create();				//创建
};
//==============================
// * 控制器与贴图 - 界面创建『多场景与游戏窗体-地图界面』
//==============================
Scene_Map.prototype.drill_HDSGi_create = function(){
	$gameTemp._drill_HDSGi_spriteTank = [];			//贴图容器（不允许出现null值）
	var cur_scene = SceneManager._scene;
	
	for(var i=0; i< $gameSystem._drill_HDSGi_controllerTank.length; i++){
		var temp_controller = $gameSystem._drill_HDSGi_controllerTank[i];
		if( temp_controller == undefined ){ continue; }
...
//==============================
Scene_Map.prototype.drill_HDSGi_updateController = function(){
	for(var i = 0; i < $gameSystem._drill_HDSGi_controllerTank.length; i++ ){
		var temp_controller = $gameSystem._drill_HDSGi_controllerTank[i];
		if( temp_controller == undefined ){ continue; }
...
//==============================
Scene_Map.prototype.drill_HDSGi_updateAttr = function(){
	var has_layerChange = false;
	for(var i = 0; i < $gameTemp._drill_HDSGi_spriteTank.length; i++){
		var temp_sprite = $gameTemp._drill_HDSGi_spriteTank[i];
...
//==============================
Scene_Map.prototype.drill_HDSGi_updateDestroy = function(){
	
	// > 自动销毁 - 控制器
	for(var i = $gameSystem._drill_HDSGi_controllerTank.length-1; i >= 0; i--){
		var temp_controller = $gameSystem._drill_HDSGi_controllerTank[i];
		if( temp_controller == undefined ){ continue; }
		if( temp_controller.drill_controller_isDead() ){
			$gameSystem._drill_HDSGi_controllerTank.splice(i,1);
		}
	}
	
	// > 自动销毁 - 贴图
	for(var i = $gameTemp._drill_HDSGi_spriteTank.length-1; i >= 0; i--){
		var temp_sprite = $gameTemp._drill_HDSGi_spriteTank[i];
		if( temp_sprite.drill_sprite_isNeedDestroy() ){
			Graphics.drill_CODS_overstoryLayerRemoveSprite( temp_sprite );	//（销毁贴图）
			$gameTemp._drill_HDSGi_spriteTank.splice(i,1);
...
//==============================
var _drill_HDSGi_sbattle_terminate = Scene_Battle.prototype.terminate;
Scene_Battle.prototype.terminate = function(){
	_drill_HDSGi_sbattle_terminate.call(this);
	$gameTemp._drill_HDSGi_spriteTank = [];		//贴图容器
	Graphics.drill_CODS_overstoryLayerClear();	//清空 天窗层
};
//==============================
...
//==============================
var _drill_HDSGi_sbattle_update = Scene_Battle.prototype.update;
Scene_Battle.prototype.update = function(){
	_drill_HDSGi_sbattle_update.call(this);
	this.drill_HDSGi_updateController();		//帧刷新 - 控制器
	this.drill_HDSGi_updateAttr();				//帧刷新 - 基础特性
	this.drill_HDSGi_updateDestroy();			//帧刷新 - 销毁
};
...
//==============================
var _drill_HDSGi_sbattle_createAllWindows = Scene_Battle.prototype.createAllWindows;
Scene_Battle.prototype.createAllWindows = function(){
	_drill_HDSGi_sbattle_createAllWindows.call(this);
	this.drill_HDSGi_create();
};
//==============================
// * 控制器与贴图 - 函数复制
//==============================
Scene_Battle.prototype.drill_HDSGi_create = Scene_Map.prototype.drill_HDSGi_create;						//界面创建       『多场景与游戏窗体-战斗界面』
Scene_Battle.prototype.drill_HDSGi_updateController = Scene_Map.prototype.drill_HDSGi_updateController;	//帧刷新 控制器  『多场景与游戏窗体-战斗界面』
Scene_Battle.prototype.drill_HDSGi_updateAttr = Scene_Map.prototype.drill_HDSGi_updateAttr;				//帧刷新 基础特性『多场景与游戏窗体-战斗界面』
Scene_Battle.prototype.drill_HDSGi_updateDestroy = Scene_Map.prototype.drill_HDSGi_updateDestroy;		//帧刷新 销毁    『多场景与游戏窗体-战斗界面』

//==============================
// * 控制器与贴图 - 销毁时『多场景与游戏窗体-菜单界面』
//==============================
var _drill_HDSGi_smenu_terminate = Scene_MenuBase.prototype.terminate;
Scene_MenuBase.prototype.terminate = function(){
	_drill_HDSGi_smenu_terminate.call(this);
	$gameTemp._drill_HDSGi_spriteTank = [];		//贴图容器
	Graphics.drill_CODS_overstoryLayerClear();	//清空 天窗层
};
//==============================
...
//==============================
var _drill_HDSGi_smenu_update = Scene_MenuBase.prototype.update;
Scene_MenuBase.prototype.update = function(){
	_drill_HDSGi_smenu_update.call(this);
	this.drill_HDSGi_updateController();		//帧刷新 - 控制器
	this.drill_HDSGi_updateAttr();				//帧刷新 - 基础特性
	this.drill_HDSGi_updateDestroy();			//帧刷新 - 销毁
};
...
//==============================
var _drill_HDSGi_smenu_createWindowLayer = Scene_MenuBase.prototype.createWindowLayer;
Scene_MenuBase.prototype.createWindowLayer = function(){
	_drill_HDSGi_smenu_createWindowLayer.call(this);
	this.drill_HDSGi_create();
};
//==============================
// * 控制器与贴图 - 函数复制
//==============================
Scene_MenuBase.prototype.drill_HDSGi_create = Scene_Map.prototype.drill_HDSGi_create;						//界面创建       『多场景与游戏窗体-菜单界面』
Scene_MenuBase.prototype.drill_HDSGi_updateController = Scene_Map.prototype.drill_HDSGi_updateController;	//帧刷新 控制器  『多场景与游戏窗体-菜单界面』
Scene_MenuBase.prototype.drill_HDSGi_updateAttr = Scene_Map.prototype.drill_HDSGi_updateAttr;				//帧刷新 基础特性『多场景与游戏窗体-菜单界面』
Scene_MenuBase.prototype.drill_HDSGi_updateDestroy = Scene_Map.prototype.drill_HDSGi_updateDestroy;			//帧刷新 销毁    『多场景与游戏窗体-菜单界面』
...
// * 控制器 - 定义
//==============================
function Drill_HDSGi_Controller(){
    this.initialize.apply(this, arguments);
};
//==============================
// * 控制器 - 初始化
//==============================
Drill_HDSGi_Controller.prototype.initialize = function( data_id ){
...
//##############################
Drill_HDSGi_Controller.prototype.drill_controller_update = function(){
...
//##############################
Drill_HDSGi_Controller.prototype.drill_controller_resetData = function( data_id ){
...
//			说明：	> 可放在帧刷新函数中实时调用。
//##############################
Drill_HDSGi_Controller.prototype.drill_controller_setVisible = function( visible ){
...
//			说明：	> 可放在帧刷新函数中实时调用。
//##############################
Drill_HDSGi_Controller.prototype.drill_controller_setPause = function( pause ){
...
//			返回：	> 布尔
//##############################
Drill_HDSGi_Controller.prototype.drill_controller_destroy = function(){
...
//			返回：	> 布尔
//##############################
Drill_HDSGi_Controller.prototype.drill_controller_isDead = function(){
...
//==============================
Drill_HDSGi_Controller.METHOD__drill_controller_setVisible                   = 11;
Drill_HDSGi_Controller.METHOD__drill_controller_setPause                     = 12;
Drill_HDSGi_Controller.METHOD__drill_controller_periodizeCommand_setPause    = 13;
Drill_HDSGi_Controller.METHOD__drill_controller_periodizeCommand_clear       = 14;

Drill_HDSGi_Controller.METHOD__drill_controller_setBlendMode                 = 21;
Drill_HDSGi_Controller.METHOD__drill_controller_setZIndex                    = 23;
Drill_HDSGi_Controller.METHOD__drill_controller_restoreBlendMode             = 24;
Drill_HDSGi_Controller.METHOD__drill_controller_restoreZIndex                = 26;

Drill_HDSGi_Controller.METHOD__drill_controller_commandChange_setOpacity     = 31;
Drill_HDSGi_Controller.METHOD__drill_controller_commandChange_setRotate      = 34;
Drill_HDSGi_Controller.METHOD__drill_controller_commandChange_setRotateSpeed = 35;

Drill_HDSGi_Controller.METHOD__drill_controller_commandChange_setScaleX      = 41;
Drill_HDSGi_Controller.METHOD__drill_controller_commandChange_setScaleY      = 42;
Drill_HDSGi_Controller.METHOD__drill_controller_commandChange_setSkewX       = 43;
Drill_HDSGi_Controller.METHOD__drill_controller_commandChange_setSkewY       = 44;
Drill_HDSGi_Controller.METHOD__drill_controller_commandChange_restoreAttr    = 45;

Drill_HDSGi_Controller.METHOD__drill_controller_commandChange_setMove        = 51;
Drill_HDSGi_Controller.METHOD__drill_controller_commandChange_restoreMove    = 52;

Drill_HDSGi_Controller.METHOD__drill_controller_GIF_setLocked                = 61;
Drill_HDSGi_Controller.METHOD__drill_controller_GIF_setOncePlay              = 62;
Drill_HDSGi_Controller.METHOD__drill_controller_GIF_setFrame                 = 63;
...
//			返回：	> 无
//##############################
Drill_HDSGi_Controller.prototype.drill_controller_setBlendMode = function( blendMode ){
...
//			返回：	> 无
//##############################
Drill_HDSGi_Controller.prototype.drill_controller_setZIndex = function( zIndex ){
...
//			返回：	> 无
//##############################
Drill_HDSGi_Controller.prototype.drill_controller_restoreBlendMode = function(){
...
//			返回：	> 无
//##############################
Drill_HDSGi_Controller.prototype.drill_controller_restoreZIndex = function(){
	var data = this.drill_data();
...
//			说明：	> 从帧数0开始计数。
//##############################
Drill_HDSGi_Controller.prototype.drill_controller_GIF_setFrame = function( cur_frame ){
	var data = this.drill_data();
...
//			返回：	> 无
//##############################
Drill_HDSGi_Controller.prototype.drill_controller_GIF_setLocked = function( locked ){
...
//			返回：	> 无
//##############################
Drill_HDSGi_Controller.prototype.drill_controller_GIF_setOncePlay = function( once_type ){
	var data = this.drill_data();
...
//##############################
Drill_HDSGi_Controller.drill_controller_initData = function( data ){
...
// * 控制器 - 初始化子功能『控制器与贴图』
//==============================
Drill_HDSGi_Controller.prototype.drill_controller_initChild = function(){
...
// * 控制器 - 重设数据（私有）
//==============================
Drill_HDSGi_Controller.prototype.drill_controller_resetData_Private = function( data_id ){
	
	// > 参数检查
	if( typeof data_id != "number" ){
		alert( DrillUp.drill_HDSGi_getPluginTip_controllerData_NotId("Drill_HDSGi_Controller") );
		throw Error( DrillUp.drill_HDSGi_getPluginTip_controllerData_NotId("Drill_HDSGi_Controller") );
		return;
	}
...
//##############################
DrillUp.g_HDSGi_notFindStyleAlertOnce = true;
//##############################
// * 控制器 - 『控制器与贴图的样式-静态数据』空的静态数据
//			
//			说明：	> 空数据会在initData时会进行默认值初始化，在其他地方只读。
//##############################
Drill_HDSGi_Controller.emptyData = {};
//##############################
...
//##############################
Drill_HDSGi_Controller.prototype.drill_data = function(){
	var cur_styleId   = this._drill_data_id +1;
	var cur_styleData = DrillUp.g_HDSGi_layers[ this._drill_data_id ];
	if( cur_styleData == undefined ){
		
		// > 『控制器与贴图的样式-静态数据』 - 校验+提示信息（只执行一次）
		if( DrillUp.g_HDSGi_notFindStyleAlertOnce == true ){
			DrillUp.g_HDSGi_notFindStyleAlertOnce = false;
			alert( DrillUp.drill_HDSGi_getPluginTip_StyleNotFind(cur_styleId) );
		}
		return Drill_HDSGi_Controller.emptyData;
	}
...
// * A主体 - 初始化子功能
//==============================
Drill_HDSGi_Controller.prototype.drill_controller_initAttr = function(){
	var data = this.drill_data();
...
// * A主体 - 帧刷新
//==============================
Drill_HDSGi_Controller.prototype.drill_controller_updateAttr = function(){
...
// * A主体 - 是否 显示/隐藏（开放函数）
//==============================
Drill_HDSGi_Controller.prototype.drill_controller_isVisible = function(){
	return this._drill_visible;
}
//==============================
// * A主体 - 是否 暂停/继续（开放函数）
//==============================
Drill_HDSGi_Controller.prototype.drill_controller_isPause = function(){
...
// * B变换特性 - 初始化子功能
//==============================
Drill_HDSGi_Controller.prototype.drill_controller_initChange = function(){
	var data = this.drill_data();
...
// * B变换特性 - 帧刷新 旋转
//==============================
Drill_HDSGi_Controller.prototype.drill_controller_updateChange_Rotation = function(){
...
//##############################
Drill_HDSGi_Controller.prototype.drill_controller_finalTransform_x = function(){
	return this._drill_change_x;
}
//##############################
// * B变换特性 - 数据最终变换值 - 位置Y（可继承，开放函数）
//##############################
Drill_HDSGi_Controller.prototype.drill_controller_finalTransform_y = function(){
	return this._drill_change_y;
}
//##############################
// * B变换特性 - 数据最终变换值 - 缩放X（可继承，开放函数）
//##############################
Drill_HDSGi_Controller.prototype.drill_controller_finalTransform_scaleX = function(){
	return this._drill_change_scaleX;
}
//##############################
// * B变换特性 - 数据最终变换值 - 缩放Y（可继承，开放函数）
//##############################
Drill_HDSGi_Controller.prototype.drill_controller_finalTransform_scaleY = function(){
	return this._drill_change_scaleY;
}
//##############################
// * B变换特性 - 数据最终变换值 - 透明度（可继承，开放函数）
//##############################
Drill_HDSGi_Controller.prototype.drill_controller_finalTransform_opacity = function(){
	return this._drill_change_opacity;
}
//##############################
// * B变换特性 - 数据最终变换值 - 斜切X（可继承，开放函数）
//##############################
Drill_HDSGi_Controller.prototype.drill_controller_finalTransform_skewX = function(){
	return this._drill_change_skewX;
}
//##############################
// * B变换特性 - 数据最终变换值 - 斜切Y（可继承，开放函数）
//##############################
Drill_HDSGi_Controller.prototype.drill_controller_finalTransform_skewY = function(){
	return this._drill_change_skewY;
}
//##############################
// * B变换特性 - 数据最终变换值 - 旋转（可继承，开放函数）
//##############################
Drill_HDSGi_Controller.prototype.drill_controller_finalTransform_rotate = function(){
	return this._drill_change_rotate;
}
//##############################
// * B变换特性 - 数据最终变换值 - 转速（可继承，开放函数）
//##############################
Drill_HDSGi_Controller.prototype.drill_controller_finalTransform_rotateSpeed = function(){
...
// * C校验值 - 初始化子功能
//==============================
Drill_HDSGi_Controller.prototype.drill_controller_initCheck = function(){
	//（无）
}
//==============================
// * C校验值 - 校验标记
//==============================
DrillUp.g_HDSGi_checkNaN = true;
//==============================
// * C校验值 - 帧刷新
//==============================
Drill_HDSGi_Controller.prototype.drill_controller_updateCheckNaN = function(){
	if( $gameTemp == undefined ){ return; }		//（测试版开启功能，发布版关闭功能）
	if( $gameTemp.isPlaytest() != true ){ return; }
	
	// > 校验值
	if( DrillUp.g_HDSGi_checkNaN == true ){
		if( isNaN( this.drill_controller_finalTransform_x() ) ){
			DrillUp.g_HDSGi_checkNaN = false;
			var check_tank = {};
			check_tank["_drill_change_x"] = this._drill_change_x;
			alert( DrillUp.drill_HDSGi_getPluginTip_ParamIsNaN( "drill_controller_finalTransform_x", check_tank ) );
		}
		if( isNaN( this.drill_controller_finalTransform_y() ) ){
			DrillUp.g_HDSGi_checkNaN = false;
			var check_tank = {};
			check_tank["_drill_change_y"] = this._drill_change_y;
			alert( DrillUp.drill_HDSGi_getPluginTip_ParamIsNaN( "drill_controller_finalTransform_y", check_tank ) );
		}
		if( isNaN( this.drill_controller_finalTransform_opacity() ) ){
			DrillUp.g_HDSGi_checkNaN = false;
			alert( DrillUp.drill_HDSGi_getPluginTip_ParamIsNaN( "drill_controller_finalTransform_opacity" ) );
		}
		if( isNaN( this.drill_controller_finalTransform_rotate() ) ){
			DrillUp.g_HDSGi_checkNaN = false;
			alert( DrillUp.drill_HDSGi_getPluginTip_ParamIsNaN( "drill_controller_finalTransform_rotate" ) );
		}
	}
}
...
//==============================
Drill_HDSGi_Controller.prototype.drill_controller_initCommandChange = function(){
...
// * D指令叠加变化 - 帧刷新
//==============================
Drill_HDSGi_Controller.prototype.drill_controller_updateCommandChange = function(){
...
// * D指令叠加变化 - 立即还原所有单属性
//==============================
Drill_HDSGi_Controller.prototype.drill_controller_commandChange_restoreAttr = function(){
...
// * D指令叠加变化 - 立即归位
//==============================
Drill_HDSGi_Controller.prototype.drill_controller_commandChange_restoreMove = function(){
	this["_drill_command_move_data"] = undefined;
}
//==============================
// * D指令叠加变化 - 修改单属性 - 移动到
//==============================
Drill_HDSGi_Controller.prototype.drill_controller_commandChange_setMove = function( change_type, tar_valueA, tar_valueB, tar_time ){
	var data = this.drill_data();
...
// * D指令叠加变化 - 修改单属性 - 透明度
//==============================
Drill_HDSGi_Controller.prototype.drill_controller_commandChange_setOpacity = function( change_type, tar_value, tar_time ){
	var data = this.drill_data();
...
// * D指令叠加变化 - 修改单属性 - 旋转
//==============================
Drill_HDSGi_Controller.prototype.drill_controller_commandChange_setRotate = function( change_type, tar_value, tar_time ){
	var data = this.drill_data();
	Drill_COBa_ExtendTool.drill_COBa_Common_controller_setTarget(
...
// * D指令叠加变化 - 修改单属性 - 转速
//==============================
Drill_HDSGi_Controller.prototype.drill_controller_commandChange_setRotateSpeed = function( change_type, tar_value, tar_time ){
	var data = this.drill_data();
	Drill_COBa_ExtendTool.drill_COBa_Common_controller_setTarget(
...
// * D指令叠加变化 - 修改单属性 - 缩放X
//==============================
Drill_HDSGi_Controller.prototype.drill_controller_commandChange_setScaleX = function( change_type, tar_value, tar_time ){
	var data = this.drill_data();
	Drill_COBa_ExtendTool.drill_COBa_Common_controller_setTarget(
...
// * D指令叠加变化 - 修改单属性 - 缩放Y
//==============================
Drill_HDSGi_Controller.prototype.drill_controller_commandChange_setScaleY = function( change_type, tar_value, tar_time ){
	var data = this.drill_data();
	Drill_COBa_ExtendTool.drill_COBa_Common_controller_setTarget(
...
// * D指令叠加变化 - 修改单属性 - 斜切X
//==============================
Drill_HDSGi_Controller.prototype.drill_controller_commandChange_setSkewX = function( change_type, tar_value, tar_time ){
	var data = this.drill_data();
	Drill_COBa_ExtendTool.drill_COBa_Common_controller_setTarget(
...
// * D指令叠加变化 - 修改单属性 - 斜切Y
//==============================
Drill_HDSGi_Controller.prototype.drill_controller_commandChange_setSkewY = function( change_type, tar_value, tar_time ){
	var data = this.drill_data();
	Drill_COBa_ExtendTool.drill_COBa_Common_controller_setTarget(
...
// * E延迟指令 - 初始化子功能
//==============================
Drill_HDSGi_Controller.prototype.drill_controller_initDelayingCommand = function(){
...
//==============================
Drill_HDSGi_Controller.prototype.drill_controller_updateDelayingCommandImportant = function(){
	...
	for(var i = 0; i < this._drill_curDelayingCommandTank.length; i++ ){
		...
		if( dc_data['left_time'] < 0 ){
			...
			if( method == Drill_HDSGi_Controller.METHOD__drill_controller_setPause ){
				this.drill_controller_setPause( paramList[0] );
			}else if( method == Drill_HDSGi_Controller.METHOD__drill_controller_periodizeCommand_setPause ){  //暂停周期指令(延迟)
				this.drill_controller_periodizeCommand_setPause( paramList[0] );
			}else if( method == Drill_HDSGi_Controller.METHOD__drill_controller_periodizeCommand_clear ){  //清空周期指令(延迟)
...
// * E延迟指令 - 帧刷新 - 执行延迟指令
//==============================
Drill_HDSGi_Controller.prototype.drill_controller_updateDelayingCommand = function(){
	if( this._drill_curDelayingCommandTank.length == 0 ){ return; }
	...
	for(var i = 0; i < this._drill_curDelayingCommandTank.length; i++ ){
		...
		if( dc_data['left_time'] < 0 ){
			...
			switch( method ){
				case Drill_HDSGi_Controller.METHOD__drill_controller_setVisible:
					this.drill_controller_setVisible( paramList[0] );
					break;
				
				case Drill_HDSGi_Controller.METHOD__drill_controller_setBlendMode:
					this.drill_controller_setBlendMode( paramList[0] );
					break;
				case Drill_HDSGi_Controller.METHOD__drill_controller_setZIndex:
					this.drill_controller_setZIndex( paramList[0] );
					break;
				case Drill_HDSGi_Controller.METHOD__drill_controller_restoreBlendMode:
					this.drill_controller_restoreBlendMode();
					break;
				case Drill_HDSGi_Controller.METHOD__drill_controller_restoreZIndex:
					this.drill_controller_restoreZIndex();
					break;
				
				case Drill_HDSGi_Controller.METHOD__drill_controller_commandChange_setOpacity:
					this.drill_controller_commandChange_setOpacity( paramList[0], paramList[1], paramList[2] );
					break;
				case Drill_HDSGi_Controller.METHOD__drill_controller_commandChange_setRotate:
					this.drill_controller_commandChange_setRotate( paramList[0], paramList[1], paramList[2] );
					break;
				case Drill_HDSGi_Controller.METHOD__drill_controller_commandChange_setRotateSpeed:
					this.drill_controller_commandChange_setRotateSpeed( paramList[0], paramList[1], paramList[2] );
					break;
					
				case Drill_HDSGi_Controller.METHOD__drill_controller_commandChange_setScaleX:
					this.drill_controller_commandChange_setScaleX( paramList[0], paramList[1], paramList[2] );
					break;
				case Drill_HDSGi_Controller.METHOD__drill_controller_commandChange_setScaleY:
					this.drill_controller_commandChange_setScaleY( paramList[0], paramList[1], paramList[2] );
					break;
				case Drill_HDSGi_Controller.METHOD__drill_controller_commandChange_setSkewX:
					this.drill_controller_commandChange_setSkewX( paramList[0], paramList[1], paramList[2] );
					break;
				case Drill_HDSGi_Controller.METHOD__drill_controller_commandChange_setSkewY:
					this.drill_controller_commandChange_setSkewY( paramList[0], paramList[1], paramList[2] );
					break;
				case Drill_HDSGi_Controller.METHOD__drill_controller_commandChange_restoreAttr:
					this.drill_controller_commandChange_restoreAttr();
					break;
				
				case Drill_HDSGi_Controller.METHOD__drill_controller_commandChange_setMove:
					this.drill_controller_commandChange_setMove( paramList[0], paramList[1], paramList[2], paramList[3] );
					break;
				case Drill_HDSGi_Controller.METHOD__drill_controller_commandChange_restoreMove:
					this.drill_controller_commandChange_restoreMove();
					break;
				
				case Drill_HDSGi_Controller.METHOD__drill_controller_GIF_setLocked:
					this.drill_controller_GIF_setLocked( paramList[0] );
					break;
				case Drill_HDSGi_Controller.METHOD__drill_controller_GIF_setOncePlay:
					this.drill_controller_GIF_setOncePlay( paramList[0] );
					break;
				case Drill_HDSGi_Controller.METHOD__drill_controller_GIF_setFrame:
...
// * E延迟指令 - 设置指令（开放函数）
//==============================
Drill_HDSGi_Controller.prototype.drill_controller_setDelayingCommand = function( method, paramList, delay_time ){
	var enable = false;
	switch( method ){
		case Drill_HDSGi_Controller.METHOD__drill_controller_setVisible:
		case Drill_HDSGi_Controller.METHOD__drill_controller_setPause:
		case Drill_HDSGi_Controller.METHOD__drill_controller_periodizeCommand_setPause:
		case Drill_HDSGi_Controller.METHOD__drill_controller_periodizeCommand_clear:
...
// * E延迟指令 - 增加延迟（开放函数）
//==============================
Drill_HDSGi_Controller.prototype.drill_controller_addDelayingTime = function( time ){
...
// * E延迟指令 - 清空全部（开放函数）
//==============================
Drill_HDSGi_Controller.prototype.drill_controller_clearDelayingCommand = function(){
	this._drill_curDelayingCommandTank = [];
}
...
// * F周期指令 - 初始化子功能
//==============================
Drill_HDSGi_Controller.prototype.drill_controller_initPeriodizeCommand = function(){
...
//			说明：	> 此处的时间流逝不会因为 暂停 而停止流逝。
//==============================
Drill_HDSGi_Controller.prototype.drill_controller_updatePeriodizeCommandImportant = function(){
...
// * F周期指令 - 帧刷新 - 执行周期指令
//==============================
Drill_HDSGi_Controller.prototype.drill_controller_updatePeriodizeCommand = function(){
	if( this._drill_curPeriodizeCommandTank.length == 0 ){ return; }
...
// * F周期指令 - 设置指令（开放函数）
//==============================
Drill_HDSGi_Controller.prototype.drill_controller_setPeriodizeCommand = function( method, paramList, time_period, time_start ){
	var enable = false;
	switch( method ){
		case Drill_HDSGi_Controller.METHOD__drill_controller_setVisible:
		case Drill_HDSGi_Controller.METHOD__drill_controller_setPause:
...
//==============================
Drill_HDSGi_Controller.prototype.drill_controller_periodizeCommand_getWaitAndClearTime = function(){
...
//==============================
Drill_HDSGi_Controller.prototype.drill_controller_periodizeCommand_setPause = function( enabled ){
...
//==============================
Drill_HDSGi_Controller.prototype.drill_controller_periodizeCommand_waitAndPause = function(){
...
//==============================
Drill_HDSGi_Controller.prototype.drill_controller_periodizeCommand_clear = function(){
	this._drill_curPeriodizeCommandTank = [];
...
//==============================
Drill_HDSGi_Controller.prototype.drill_controller_periodizeCommand_waitAndClear = function(){
...
// * G自变化效果 - 初始化子功能
//==============================
Drill_HDSGi_Controller.prototype.drill_controller_initEffect = function(){
	this._drill_curEffectTime = 0;
}
//==============================
// * G自变化效果 - 帧刷新
//==============================
Drill_HDSGi_Controller.prototype.drill_controller_updateEffect = function(){
...
// * O播放GIF - 初始化子功能
//==============================
Drill_HDSGi_Controller.prototype.drill_controller_initGIF = function(){
	var data = this.drill_data();
...
// * O播放GIF - 帧刷新
//==============================
Drill_HDSGi_Controller.prototype.drill_controller_updateGIF = function(){
	var data = this.drill_data();
...
// * P预加载GIF管理 - 初始化子功能
//==============================
Drill_HDSGi_Controller.prototype.drill_controller_initPreload = function(){
	//	（无）
}
...
//==============================
Drill_HDSGi_Controller.prototype.drill_controller_initRandomPos = function(){
	var data = this.drill_data();
...
// * Q随机位置 - 帧刷新
//==============================
Drill_HDSGi_Controller.prototype.drill_controller_updateRandomPos = function(){
	var data = this.drill_data();
...
// * GIF贴图 - 定义
//==============================
function Drill_HDSGi_Sprite() {
    this.initialize.apply(this, arguments);
};
Drill_HDSGi_Sprite.prototype = Object.create(Sprite.prototype);
Drill_HDSGi_Sprite.prototype.constructor = Drill_HDSGi_Sprite;
//==============================
// * GIF贴图 - 初始化
//==============================
Drill_HDSGi_Sprite.prototype.initialize = function(){
...
// * GIF贴图 - 帧刷新
//==============================
Drill_HDSGi_Sprite.prototype.update = function(){
...
//##############################
Drill_HDSGi_Sprite.prototype.drill_sprite_setController = function( controller ){
...
//##############################
Drill_HDSGi_Sprite.prototype.drill_sprite_initChild = function(){
...
//			说明：	> 这里完全 不考虑 延迟加载问题。
//##############################
Drill_HDSGi_Sprite.prototype.drill_sprite_isReady = function(){
...
//##############################
Drill_HDSGi_Sprite.prototype.drill_sprite_isOptimizationPassed = function(){
	return true;
};
//##############################
// * GIF贴图 - 是否需要销毁【标准函数】
...
//##############################
Drill_HDSGi_Sprite.prototype.drill_sprite_isNeedDestroy = function(){
...
//##############################
Drill_HDSGi_Sprite.prototype.drill_sprite_destroy = function(){
...
// * GIF贴图 - 初始化自身『控制器与贴图』
//==============================
Drill_HDSGi_Sprite.prototype.drill_sprite_initSelf = function(){
...
// * GIF贴图 - 销毁子功能『控制器与贴图』
//==============================
Drill_HDSGi_Sprite.prototype.drill_sprite_destroyChild = function(){
...
// * GIF贴图 - 销毁自身『控制器与贴图』
//==============================
Drill_HDSGi_Sprite.prototype.drill_sprite_destroySelf = function(){
	this._drill_controller = null;				//控制器对象
	this._drill_curSerial = -1;					//当前序列号
};
...
// * A贴图主体 - 初始化子功能
//==============================
Drill_HDSGi_Sprite.prototype.drill_sprite_initAttr = function(){
...
// * A贴图主体 - 帧刷新
//==============================
Drill_HDSGi_Sprite.prototype.drill_sprite_updateAttr = function(){
	...
	//（其它 基础特性 的帧刷新赋值见：drill_HDSGi_updateAttr）
}
...
// * B变换特性 - 初始化子功能
//==============================
Drill_HDSGi_Sprite.prototype.drill_sprite_initChange = function(){
...
// * B变换特性 - 帧刷新
//==============================
Drill_HDSGi_Sprite.prototype.drill_sprite_updateChange = function(){
...
//					> 参数使用字符串进行控制，默认为 null 值。
//==============================
Drill_HDSGi_Sprite.prototype.drill_sprite_initCommandChange = function(){
...
// * D指令叠加变化-控制器用 - 帧刷新
//==============================
Drill_HDSGi_Sprite.prototype.drill_sprite_updateCommandChange = function(){
	var data = this._drill_controller.drill_data();
...
// * E延迟指令 - 初始化子功能
//==============================
Drill_HDSGi_Sprite.prototype.drill_sprite_initDelayingCommand = function(){
	//（无）
}
...
// * F周期指令 - 初始化子功能
//==============================
Drill_HDSGi_Sprite.prototype.drill_sprite_initPeriodizeCommand = function(){
	//（无）
}
...
// * G自变化效果 - 初始化子功能
//==============================
Drill_HDSGi_Sprite.prototype.drill_sprite_initEffect = function(){
	//（无）
}
//==============================
// * G自变化效果 - 帧刷新
//==============================
Drill_HDSGi_Sprite.prototype.drill_sprite_updateEffect = function(){
	var data = this._drill_controller.drill_data();
...
// * O播放GIF - 初始化子功能
//==============================
Drill_HDSGi_Sprite.prototype.drill_sprite_initGIF = function(){
	//	（无）
}
//==============================
// * O播放GIF - 帧刷新
//==============================
Drill_HDSGi_Sprite.prototype.drill_sprite_updateGIF = function(){
...
// * O播放GIF - 获取资源bitmap
//==============================
Drill_HDSGi_Sprite.prototype.drill_sprite_getGIFBitmapByIndex = function( index ){
...
//==============================
Drill_HDSGi_Sprite.prototype.drill_sprite_initPreload = function(){
	this._drill_load_curTime = 0;			//当前加载时间
}
//==============================
// * P预加载GIF管理 - 帧刷新
//==============================
Drill_HDSGi_Sprite.prototype.drill_sprite_updatePreload = function(){
	if( this.visible != true ){ return; }	//（显示时才帧刷新）
	var data = this._drill_controller.drill_data();
...
//==============================
Drill_HDSGi_Sprite.prototype.drill_sprite_getReadyTank_ForDebug = function(){
	var data = this._drill_controller.drill_data();
	var isReady_tank = [];
...
// * Q随机位置 - 初始化子功能
//==============================
Drill_HDSGi_Sprite.prototype.drill_sprite_initRandomPos = function(){
	//	（无）
}
...
//=============================================================================
		...
		Imported.Drill_HtmlDynamicSnapshotGif = false;
		var pluginTip = DrillUp.drill_HDSGi_getPluginTip_NoBasePlugin();
		alert( pluginTip );
}
