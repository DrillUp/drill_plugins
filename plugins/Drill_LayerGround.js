...
Scene_Map.prototype.update = function() {
	...
	this.drill_LG_updateAttr();					//帧刷新 - 主体属性变化
...
Scene_Map.prototype.drill_LG_updateAttr = function() {
	...
	for(var i = 0; i < $gameTemp._drill_LG_spriteTank.length; i++){
		...
		if( temp_sprite.layerIndex != temp_data['layerIndex'] ){
			...
			this.drill_LG_layerAddSprite( temp_sprite, temp_data['layerIndex'] );
...
// * B基本变化 - 帧刷新 旋转
//==============================
Drill_LG_Controller.prototype.drill_controller_updateChange_Rotation = function(){
	var data = this._drill_data;
...
Drill_LG_Controller.prototype.drill_controller_updateChange_MoveRange = function(){
	...
	// > 锁定锚点
	var point = $gameTemp.drill_LG_Math2D_getFixPointInAnchor(
		0, 0,
		0.5, 0.5,
...
//					旋转值和缩放值可为负数。
//==============================
Game_Temp.prototype.drill_LG_Math2D_getFixPointInAnchor = function( 
...
Drill_LG_Sprite.prototype.drill_sprite_updateAttr = function() {
	...
	if( this._drill_spriteMove_x != this._drill_controller._drill_move_x ||
		...
		// > 测试查看矩形范围
		//if( this._drill_spriteMove_x != 0 ){
		//	alert( this._drill_spriteMove_x+","+this._drill_spriteMove_y+","+this._drill_spriteMove_w+","+this._drill_spriteMove_h );
		//}
	}
}
