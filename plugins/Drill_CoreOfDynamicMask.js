...
Game_Interpreter.prototype.pluginCommand = function( command, args ){
	...
	this.drill_CODM_pluginCommand( command, args );
}
//==============================
// * 插件指令 - 指令执行
//==============================
Game_Interpreter.prototype.drill_CODM_pluginCommand = function( command, args ){
	if( command === ">动态遮罩核心" ){
		if( args.length == 2 ){
...
// **		
// **		说明：	> 此功能就是一个简易的动态遮罩板。
// **				> 该贴图需要绑定到目标贴图的 .mask 中。单独显示也可以，为黑白蒙版的图像。
// **				> 注意，这是一个固定 高宽 的贴图对象。
// **				
