 ...
 * 插件指令：>标题GIF : 隐藏全部
 *
 * 1."GIF[2]"中的数字表示对应插件配置的编号，只能一个一个改。
...
//==============================
Drill_TGi_Controller.METHOD__drill_controller_setVisible                   = 11;
Drill_TGi_Controller.METHOD__drill_controller_setPause                     = 12;
Drill_TGi_Controller.METHOD__drill_controller_periodizeCommand_setPause    = 13;
Drill_TGi_Controller.METHOD__drill_controller_periodizeCommand_clear       = 14;

Drill_TGi_Controller.METHOD__drill_controller_setBlendMode                 = 21;
Drill_TGi_Controller.METHOD__drill_controller_setLayerIndex                = 22;
Drill_TGi_Controller.METHOD__drill_controller_setZIndex                    = 23;
Drill_TGi_Controller.METHOD__drill_controller_restoreBlendMode             = 24;
Drill_TGi_Controller.METHOD__drill_controller_restoreLayerIndex            = 25;
Drill_TGi_Controller.METHOD__drill_controller_restoreZIndex                = 26;

Drill_TGi_Controller.METHOD__drill_controller_commandChange_setOpacity     = 31;
Drill_TGi_Controller.METHOD__drill_controller_commandChange_setRotate      = 34;
Drill_TGi_Controller.METHOD__drill_controller_commandChange_setRotateSpeed = 35;

Drill_TGi_Controller.METHOD__drill_controller_commandChange_setScaleX      = 41;
Drill_TGi_Controller.METHOD__drill_controller_commandChange_setScaleY      = 42;
Drill_TGi_Controller.METHOD__drill_controller_commandChange_setSkewX       = 43;
Drill_TGi_Controller.METHOD__drill_controller_commandChange_setSkewY       = 44;
Drill_TGi_Controller.METHOD__drill_controller_commandChange_restoreAttr    = 45;

Drill_TGi_Controller.METHOD__drill_controller_commandChange_setMove        = 51;
Drill_TGi_Controller.METHOD__drill_controller_commandChange_restoreMove    = 52;

Drill_TGi_Controller.METHOD__drill_controller_GIF_setLocked                = 61;
Drill_TGi_Controller.METHOD__drill_controller_GIF_setOncePlay              = 62;
Drill_TGi_Controller.METHOD__drill_controller_GIF_setFrame                 = 63;
...
//			返回：	> 无
//##############################
Drill_TGi_Controller.prototype.drill_controller_restoreBlendMode = function(){
...
//			返回：	> 无
//##############################
Drill_TGi_Controller.prototype.drill_controller_restoreLayerIndex = function(){
	var data = this.drill_data();
...
//			返回：	> 无
//##############################
Drill_TGi_Controller.prototype.drill_controller_restoreZIndex = function(){
	var data = this.drill_data();
...
//==============================
Drill_TGi_Controller.prototype.drill_controller_isVisible = function(){
	if( DrillUp.global_TGi_visibleTank[ this._drill_data_id ] === false ){ return false; }
	return this._drill_visible;
}
//==============================
// * A主体 - 是否 暂停/继续（开放函数）
//==============================
Drill_TGi_Controller.prototype.drill_controller_isPause = function(){
...
Drill_TGi_Controller.prototype.drill_controller_updateDelayingCommandImportant = function(){
	...
	for(var i = 0; i < this._drill_curDelayingCommandTank.length; i++ ){
		...
		if( dc_data['left_time'] < 0 ){
			...
			if( method == Drill_TGi_Controller.METHOD__drill_controller_setPause ){
				this.drill_controller_setPause( paramList[0] );
			}else if( method == Drill_TGi_Controller.METHOD__drill_controller_periodizeCommand_setPause ){  //暂停周期指令(延迟)
				this.drill_controller_periodizeCommand_setPause( paramList[0] );
			}else if( method == Drill_TGi_Controller.METHOD__drill_controller_periodizeCommand_clear ){  //清空周期指令(延迟)
...
Drill_TGi_Controller.prototype.drill_controller_updateDelayingCommand = function(){
	...
	for(var i = 0; i < this._drill_curDelayingCommandTank.length; i++ ){
		...
		if( dc_data['left_time'] < 0 ){
			...
			switch( method ){
				case Drill_TGi_Controller.METHOD__drill_controller_setVisible:
					this.drill_controller_setVisible( paramList[0] );
					break;
				
				case Drill_TGi_Controller.METHOD__drill_controller_setBlendMode:
					this.drill_controller_setBlendMode( paramList[0] );
					break;
				case Drill_TGi_Controller.METHOD__drill_controller_setLayerIndex:
					this.drill_controller_setLayerIndex( paramList[0] );
					break;
				case Drill_TGi_Controller.METHOD__drill_controller_setZIndex:
					this.drill_controller_setZIndex( paramList[0] );
					break;
				case Drill_TGi_Controller.METHOD__drill_controller_restoreBlendMode:
					this.drill_controller_restoreBlendMode();
					break;
				case Drill_TGi_Controller.METHOD__drill_controller_restoreLayerIndex:
					this.drill_controller_restoreLayerIndex();
					break;
				case Drill_TGi_Controller.METHOD__drill_controller_restoreZIndex:
					this.drill_controller_restoreZIndex();
					break;
				
				case Drill_TGi_Controller.METHOD__drill_controller_commandChange_setOpacity:
					this.drill_controller_commandChange_setOpacity( paramList[0], paramList[1], paramList[2] );
					break;
				case Drill_TGi_Controller.METHOD__drill_controller_commandChange_setRotate:
					this.drill_controller_commandChange_setRotate( paramList[0], paramList[1], paramList[2] );
					break;
				case Drill_TGi_Controller.METHOD__drill_controller_commandChange_setRotateSpeed:
					this.drill_controller_commandChange_setRotateSpeed( paramList[0], paramList[1], paramList[2] );
					break;
					
				case Drill_TGi_Controller.METHOD__drill_controller_commandChange_setScaleX:
					this.drill_controller_commandChange_setScaleX( paramList[0], paramList[1], paramList[2] );
					break;
				case Drill_TGi_Controller.METHOD__drill_controller_commandChange_setScaleY:
					this.drill_controller_commandChange_setScaleY( paramList[0], paramList[1], paramList[2] );
					break;
				case Drill_TGi_Controller.METHOD__drill_controller_commandChange_setSkewX:
					this.drill_controller_commandChange_setSkewX( paramList[0], paramList[1], paramList[2] );
					break;
				case Drill_TGi_Controller.METHOD__drill_controller_commandChange_setSkewY:
					this.drill_controller_commandChange_setSkewY( paramList[0], paramList[1], paramList[2] );
					break;
				case Drill_TGi_Controller.METHOD__drill_controller_commandChange_restoreAttr:
					this.drill_controller_commandChange_restoreAttr();
					break;
				
				case Drill_TGi_Controller.METHOD__drill_controller_commandChange_setMove:
					this.drill_controller_commandChange_setMove( paramList[0], paramList[1], paramList[2], paramList[3] );
					break;
				case Drill_TGi_Controller.METHOD__drill_controller_commandChange_restoreMove:
					this.drill_controller_commandChange_restoreMove();
					break;
				
				case Drill_TGi_Controller.METHOD__drill_controller_GIF_setLocked:
					this.drill_controller_GIF_setLocked( paramList[0] );
					break;
				case Drill_TGi_Controller.METHOD__drill_controller_GIF_setOncePlay:
					this.drill_controller_GIF_setOncePlay( paramList[0] );
					break;
				case Drill_TGi_Controller.METHOD__drill_controller_GIF_setFrame:
...
Drill_TGi_Controller.prototype.drill_controller_setDelayingCommand = function( method, paramList, delay_time ){
	...
	switch( method ){
		case Drill_TGi_Controller.METHOD__drill_controller_setVisible:
		case Drill_TGi_Controller.METHOD__drill_controller_setPause:
		case Drill_TGi_Controller.METHOD__drill_controller_periodizeCommand_setPause:
		case Drill_TGi_Controller.METHOD__drill_controller_periodizeCommand_clear:
...
// * E延迟指令 - 增加延迟（开放函数）
//==============================
Drill_TGi_Controller.prototype.drill_controller_addDelayingTime = function( time ){
...
//==============================
Drill_TGi_Controller.prototype.drill_controller_periodizeCommand_getWaitAndClearTime = function(){
...
//==============================
Drill_TGi_Controller.prototype.drill_controller_periodizeCommand_setPause = function( enabled ){
...
//==============================
Drill_TGi_Controller.prototype.drill_controller_periodizeCommand_waitAndPause = function(){
...
//==============================
Drill_TGi_Controller.prototype.drill_controller_periodizeCommand_clear = function(){
	this._drill_curPeriodizeCommandTank = [];
...
//==============================
Drill_TGi_Controller.prototype.drill_controller_periodizeCommand_waitAndClear = function(){
