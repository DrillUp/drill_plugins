...
//=============================================================================
	...
	if( DrillUp.parameters["用语-锁定的描述内容"] != undefined && 
		...
		DrillUp.g_SSpH_locked_context = JSON.parse( DrillUp.parameters["用语-锁定的描述内容"] );
	}else{
...
Drill_SSpH_SelectWindow.prototype.drill_window_drawItem = function( index ){
	...
	// > 参数准备 - 窗口字符对齐方式
	var cur_align = DrillUp.g_SSpH_selWin_align;
...
Drill_SSpH_DescWindow.prototype.drill_refreshDescText = function( cur_index ){
	...
	if( $gameTemp.drill_SSpH_isLocked( temp_data['index'] ) == true && 
		...
		if( temp_data['lockedContextEnabled'] == true ){
			...
			context = DrillUp.g_SSpH_locked_context;	//用语-锁定的描述内容
		}
	}else{
