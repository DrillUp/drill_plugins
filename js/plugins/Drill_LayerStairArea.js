...
Game_CharacterBase.prototype.initialize = function(){
	...
	this._drill_LSA_jumpX = 0;				//跳跃时，起跳点X
	this._drill_LSA_jumpY = 0;				//跳跃时，起跳点Y
	this._drill_LSA_jumpTime = 0;			//跳跃时长
}
//==============================
// * 物体 - 判断在阶梯区域（硬性xy坐标）
//==============================
...
Game_CharacterBase.prototype.drill_LSA_updateStairY = function(){
	...
	//------------------------------
	// > 一般情况
	if( this._drill_LSA_stairTag == 0 && this.drill_LSA_isOnStairFloor() ){
...
Game_CharacterBase.prototype.moveStraight = function( d ){
	...
	// > 获取标记
	var stair_tag = $gameMap.drill_LSA_getStairTag( this._x, this._y, d );
...
Game_Player.prototype.checkEventTriggerThere = function( triggers ){
    ...
    if( this.canStartLocalEvents() ){
		...
		if( d == 4 || d == 6 ){
			var x = this._x;
			var y = this._y;
			var stair_tag = $gameMap.drill_LSA_getStairTag( x, y, d );
