...
DrillUp.drill_HWM_setWindowMove = function( type, temp1 ){
	if( SceneManager.drill_HWM_isMoving() ){ return; } 
...
Graphics._onWindowResize = function() {
	if( SceneManager.drill_HWM_isMoving() == true ){ return; } 	//移动时，不改变事件
	_drill_HWM__onWindowResize.call(this);
}
//==============================
// * 视图 - 刷新渲染器
//==============================
var _drill_HWM__updateRenderer = Graphics._updateRenderer;
Graphics._updateRenderer = function() {
	if( SceneManager.drill_HWM_isMoving() == true ){ return; } 	//移动时，不改变事件
	_drill_HWM__updateRenderer.call(this);
}
//==============================
// * 视图 - 刷新比例
//==============================
...
if( Imported.Drill_HtmlBackground ){	//（该插件可以放 黑边背景 后面，也可以不放，不影响实际效果）
	//==============================
	// * 刷新 - canvas画布
	//==============================
	var _drill_HWM_HB_updateCanvas = Graphics.drill_HB_updateCanvas;
	Graphics.drill_HB_updateCanvas = function() {
		if( SceneManager.drill_HWM_isMoving() == true ){ return; } 	//移动时，不改变事件
		_drill_HWM_HB_updateCanvas.call(this);
	}
	//==============================
	// * 刷新 - render渲染器
	//==============================
	var _drill_HWM_HB_updateRenderer = Graphics.drill_HB_updateRenderer;
	Graphics.drill_HB_updateRenderer = function() {
		if( SceneManager.drill_HWM_isMoving() == true ){ return; } 	//移动时，不改变事件
		_drill_HWM_HB_updateRenderer.call(this);
	}
}
...
SceneManager.renderScene = function() {
	...
	if( this.drill_HWM_isMoving() == false ){ return; }
...
// * 窗口 - 判断移动
//==============================
SceneManager.drill_HWM_isMoving = function() {
