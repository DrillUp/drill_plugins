 ...
 * 1.插件的作用域：地图界面。
 *   作用于行走图。
 * 2.更多详细内容，去看看"关于行走图GIF动画序列核心.docx"。
 * 细节：
 ...
 *      可以通过该插件实现事件GIF效果。
 *   (2.你也可以去看看"关于GIF动画序列核心.docx" ，了解通过
 *      小工具配置GIF动画序列的方法。
 * 
 * -----------------------------------------------------------------------------
 * ----激活条件 - 动画序列
 ...
 * 你需要通过下面插件指令来操作动画序列：
 * 
 * 插件指令：>行走图动画序列 : 事件[1] : 修改集合 : 集合[小爱丽丝静止1,小爱丽丝静止2]
 * 插件指令：>行走图动画序列 : 事件[1] : 修改集合(立即切换) : 集合[小爱丽丝静止1,小爱丽丝静止2]
 * 插件指令：>行走图动画序列 : 事件[1] : 还原默认集合
