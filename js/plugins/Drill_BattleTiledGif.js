 ...
 * 3."变坐标"的变化效果可以与速度叠加。
 * 4."混合模式"为瞬间切换，可以去看看"pixi的渲染混合模式"。
 * 5.插件指令的变化是永久性的。
 *   如果你想瞬间切换，设置变化时间为0即可。
 * 6.平铺GIF无法变缩放，无法变斜切。
 * 
...
Game_Interpreter.prototype.pluginCommand = function(command, args) {
	...
	/*-----------------旧指令------------------*/
	if( command === ">战斗平铺GIF" ){				// >战斗平铺GIF : A : 变色调 : H : I : J1 : J2 : J3 : J4
		if(args.length >= 8){
			var temp1 = String(args[1]);
			var type = String(args[3]);
...
// ** 下层
//==============================
var _drill_BTG_layer_createBattleback = Spriteset_Battle.prototype.createBattleback;
Spriteset_Battle.prototype.createBattleback = function() {    
	_drill_BTG_layer_createBattleback.call(this);
...
// ** 上层
//==============================
var _drill_BTG_layer_createLowerLayer = Spriteset_Battle.prototype.createLowerLayer;
Spriteset_Battle.prototype.createLowerLayer = function() {
    _drill_BTG_layer_createLowerLayer.call(this);
...
// ** 图片层
//==============================
var _drill_BTG_layer_createPictures = Spriteset_Battle.prototype.createPictures;
Spriteset_Battle.prototype.createPictures = function() {
	_drill_BTG_layer_createPictures.call(this);		//rmmv图片 < 图片层 < rmmv对话框
...
// ** 最顶层
//==============================
var _drill_BTG_layer_createAllWindows = Scene_Battle.prototype.createAllWindows;
Scene_Battle.prototype.createAllWindows = function() {
	_drill_BTG_layer_createAllWindows.call(this);	//rmmv对话框 < 最顶层
